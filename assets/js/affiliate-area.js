...
(function(){
  ...
  const CREATOR_DASHBOARD_I18N = {
    it: {
      ...
      creatorPanelSubtitle: 'Qui vedi le interazioni generate dai tuoi post influencer.',
    ...
    en: {
      ...
      creatorPanelSubtitle: 'Here you can see the interactions generated by your influencer posts.',
      profileViews: 'Profile views',
      cardImpressions: 'Card impressions',
      postOpens: 'Post opens',
    ...
    de: {
      ...
      creatorPanelSubtitle: 'Hier siehst du die Interaktionen, die deine Influencer-Posts erzeugt haben.',
      profileViews: 'Profilaufrufe',
      cardImpressions: 'Card-Impressionen',
      postOpens: 'Post-Öffnungen',
    ...
    es: {
      ...
      creatorPanelSubtitle: 'Aquí ves las interacciones generadas por tus posts influencer.',
      profileViews: 'Visitas del perfil',
      cardImpressions: 'Impresiones de tarjeta',
      postOpens: 'Aperturas de post',
    ...
    fr: {
      ...
      creatorPanelSubtitle: 'Vous voyez ici les interactions générées par vos posts influenceur.',
      profileViews: 'Vues du profil',
      cardImpressions: 'Impressions carte',
      postOpens: 'Ouvertures du post',
    ...
    nl: {
      ...
      creatorPanelSubtitle: 'Hier zie je de interacties die door je influencer-posts zijn gegenereerd.',
      profileViews: 'Profielweergaven',
      cardImpressions: 'Kaartweergaven',
      postOpens: 'Post-openingen',
    ...
    ru: {
      ...
      creatorPanelSubtitle: 'Здесь показаны взаимодействия, которые принесли ваши посты.',
      profileViews: 'Просмотры профиля',
      cardImpressions: 'Показы карточек',
      postOpens: 'Открытия поста',
    ...
    ar: {
      ...
      creatorPanelSubtitle: 'هنا ترى التفاعلات التي حققتها منشوراتك.',
    ...
    zh: {
      ...
      creatorPanelSubtitle: '这里会显示你的 Influencer 帖子带来的互动。',
      profileViews: '资料浏览量',
  ...
  function init(){
    ...
    function ensureCreatorStatsWrap(){
      ...
      creatorStatsWrap.className = 'affiliate-influencer-card affiliate-influencer-card--inside-overview';
      ...
      var creatorAnchor = $('#affiliate-creator-anchor', views.dashboard);
      var overviewPanel = $('#affiliate-overview-panel', views.dashboard);
      if (creatorAnchor && creatorAnchor.parentNode) {
        creatorAnchor.parentNode.insertBefore(creatorStatsWrap, creatorAnchor);
      } else if (overviewPanel) {
        overviewPanel.appendChild(creatorStatsWrap);
      } else {
        var insertAfter = $('.affiliate-stats-grid', views.dashboard) || $('.affiliate-balance-hero', views.dashboard) || $('.affiliate-id-block', views.dashboard) || $('.auth-card-header', views.dashboard);
