...
(function(){
  ...
  const CREATOR_DASHBOARD_I18N = {
    it: {
      ...
      creatorPanelSubtitle: 'Qui vedi le interazioni generate dai tuoi post influencer: visite profilo, aperture popup, click widget outbound e vendite confermate attribuite ai tuoi contenuti.',
      ...
      bookingConfirmed: 'Vendite confermate dai tuoi post',
      ...
      creatorPanelNote: 'Tutte le metriche qui sotto sono totali storici. I click outbound e le vendite attribuite ai post appariranno qui non appena arrivano i dati dei partner.',
      creatorPanelBadge: 'Vlogs de influencers'
    },
    en: {
      creatorPanelTitle: 'Creator performance',
      creatorPanelSubtitle: 'Here you can see the interactions generated by your influencer posts: profile views, popup opens, outbound widget clicks and confirmed sales attributed to your content.',
      ...
      bookingConfirmed: 'Confirmed sales from your posts',
      ...
      creatorPanelNote: 'All metrics below are lifetime totals. Outbound clicks and sales attributed to your posts will appear here as soon as partner data arrives.',
      creatorPanelBadge: 'Vlogs de influencers'
    },
    de: {
      creatorPanelTitle: 'Creator-Leistung',
      creatorPanelSubtitle: 'Hier siehst du die Interaktionen deiner Influencer-Posts: Profilaufrufe, Popup-Öffnungen, Outbound-Widget-Klicks und bestätigte Verkäufe deiner Inhalte.',
      ...
      bookingConfirmed: 'Bestätigte Verkäufe aus deinen Posts',
      ...
      creatorPanelNote: 'Alle folgenden Kennzahlen sind historische Gesamtwerte. Outbound-Klicks und Verkäufe aus deinen Posts erscheinen hier, sobald Partnerdaten eintreffen.',
      creatorPanelBadge: 'Influencer-Vlogs'
    },
    es: {
      creatorPanelTitle: 'Rendimiento del creador',
      creatorPanelSubtitle: 'Aquí ves las interacciones generadas por tus posts influencer: visitas al perfil, aperturas del popup, clics outbound en widgets y ventas confirmadas atribuidas a tu contenido.',
      profileViews: 'Visitas del perfil',
      cardImpressions: 'Impresiones de tarjeta',
      postOpens: 'Aperturas del popup',
      widgetClicks: 'Clics outbound en widgets',
      bookingPending: 'Reservas pendientes',
      bookingConfirmed: 'Ventas confirmadas de tus posts',
      ...
      creatorPanelNote: 'Todas las métricas de abajo son totales históricos. Los clics outbound y las ventas atribuidas a tus posts aparecerán aquí en cuanto lleguen los datos del partner.',
      creatorPanelBadge: 'Vlogs de influencers'
    },
    fr: {
      creatorPanelTitle: 'Performance créateur',
      creatorPanelSubtitle: 'Vous voyez ici les interactions générées par vos posts influenceur : vues du profil, ouvertures du popup, clics widget sortants et ventes confirmées attribuées à vos contenus.',
      profileViews: 'Vues du profil',
      cardImpressions: 'Impressions carte',
      postOpens: 'Ouvertures popup',
      widgetClicks: 'Clics widget sortants',
      bookingPending: 'Réservations en attente',
      bookingConfirmed: 'Ventes confirmées de vos posts',
      ...
      creatorPanelNote: 'Toutes les métriques ci-dessous sont des totaux historiques. Les clics sortants et les ventes attribuées à vos posts apparaîtront ici dès réception des données partenaires.',
      creatorPanelBadge: 'Vlogs d’influenceurs'
    },
    nl: {
      creatorPanelTitle: 'Creator-prestaties',
      creatorPanelSubtitle: 'Hier zie je de interacties die door je influencer-posts zijn gegenereerd: profielweergaven, popup-openingen, outbound widgetklikken en bevestigde verkopen uit je content.',
      ...
      bookingConfirmed: 'Bevestigde verkopen uit je posts',
      ...
      creatorPanelNote: 'Alle onderstaande statistieken zijn historische totalen. Outbound klikken en verkopen uit je posts verschijnen hier zodra partnerdata binnenkomt.',
      creatorPanelBadge: 'Influencer-vlogs'
    },
    ru: {
      creatorPanelTitle: 'Статистика автора',
      creatorPanelSubtitle: 'Здесь показаны взаимодействия, которые принесли ваши посты: просмотры профиля, открытия попапов, исходящие клики по виджетам и подтверждённые продажи по вашим материалам.',
      profileViews: 'Просмотры профиля',
      cardImpressions: 'Показы карточек',
      postOpens: 'Открытия попапа',
      widgetClicks: 'Исходящие клики по виджету',
      bookingPending: 'Ожидающие бронирования',
      bookingConfirmed: 'Подтверждённые продажи из ваших постов',
      ...
      creatorPanelNote: 'Все показатели ниже — это исторические итоги. Исходящие клики и продажи, привязанные к вашим постам, появятся здесь после получения данных от партнёров.',
      creatorPanelBadge: 'Влоги инфлюенсеров'
    },
    ar: {
      creatorPanelTitle: 'أداء المنشئ',
      creatorPanelSubtitle: 'هنا ترى التفاعلات التي حققتها منشوراتك: زيارات الملف، فتحات النافذة المنبثقة، نقرات الودجت الخارجية والمبيعات المؤكدة المنسوبة إلى محتواك.',
      profileViews: 'زيارات الملف',
      cardImpressions: 'مرات ظهور البطاقة',
      postOpens: 'مرات فتح المنشور',
      widgetClicks: 'نقرات الودجت الخارجية',
      bookingPending: 'الحجوزات المعلقة',
      bookingConfirmed: 'المبيعات المؤكدة من منشوراتك',
      ...
      creatorPanelNote: 'كل المقاييس أدناه هي إجماليات تاريخية. ستظهر النقرات الخارجية والمبيعات المنسوبة إلى منشوراتك هنا فور وصول بيانات الشركاء.',
      creatorPanelBadge: 'مدونات المؤثرين'
    },
    zh: {
      creatorPanelTitle: '创作者表现',
      creatorPanelSubtitle: '这里会显示你的 Influencer 帖子带来的互动：资料浏览、弹窗打开、外跳组件点击，以及归因到你内容的已确认销售。',
      profileViews: '资料浏览量',
      cardImpressions: '卡片曝光',
      postOpens: '弹窗打开',
      widgetClicks: '外跳组件点击',
      bookingPending: '待处理预订',
      bookingConfirmed: '来自你帖子的已确认销售',
      estimatedRevenue: '预估合作佣金',
      confirmedRevenue: '已确认合作佣金',
      noCreatorData: '暂时没有可显示的创作者数据。',
      creatorPanelNote: '下方所有指标均为历史累计值。归属于你帖子的外跳点击和销售一旦从合作伙伴到达，就会显示在这里。',
    ...
    async function loadDashboardStats(){
      ...
      try{
        ...
        var influencerStatsPromise = client
          ...
          .select('affiliate_slug,profile_views,post_opens,widget_clicks,booking_confirmed')
          .eq('affiliate_slug', slug)
          .maybeSingle();
