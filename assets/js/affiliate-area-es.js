...
(function(){
  ...
  const CREATOR_DASHBOARD_I18N = {
    it: {
      creatorPanelTitle: 'Performance creator',
      creatorPanelSubtitle: 'Qui vedi le interazioni generate dai tuoi post influencer: impression, aperture popup, click widget e conversioni attribuite ai tuoi contenuti.',
      ...
      bookingConfirmed: 'Booking confermati',
      estimatedRevenue: 'Commissione partner stimata',
      confirmedRevenue: 'Commissione partner confermata',
      noCreatorData: 'Non hai ancora dati creator da mostrare.',
      creatorPanelNote: 'I click sui widget dei post vengono misurati qui. Le vendite attribuite ai post appariranno non appena arrivano i dati dei partner.',
      creatorPanelBadge: 'Vlogs de influencers'
    },
    en: {
      creatorPanelTitle: 'Creator performance',
      creatorPanelSubtitle: 'Here you can see the interactions generated by your influencer posts: card impressions, popup opens, widget clicks and attributed conversions.',
      profileViews: 'Profile views',
      cardImpressions: 'Card impressions',
      postOpens: 'Post popup opens',
      widgetClicks: 'Outbound widget clicks',
      bookingPending: 'Pending bookings',
      bookingConfirmed: 'Confirmed bookings',
      estimatedRevenue: 'Estimated partner commission',
      confirmedRevenue: 'Confirmed partner commission',
      noCreatorData: 'You do not have creator data to show yet.',
      creatorPanelNote: 'Post widget clicks are measured here. Sales attributed to posts will appear here as soon as partner data arrives.',
      creatorPanelBadge: 'Vlogs de influencers'
    },
    de: {
      creatorPanelTitle: 'Creator-Leistung',
      creatorPanelSubtitle: 'Hier siehst du die Interaktionen deiner Influencer-Posts: Card-Impressionen, Popup-Öffnungen, Widget-Klicks und zugeordnete Conversions.',
      profileViews: 'Profilaufrufe',
      cardImpressions: 'Card-Impressionen',
      postOpens: 'Post-Popup-Öffnungen',
      widgetClicks: 'Outbound-Widget-Klicks',
      bookingPending: 'Offene Buchungen',
      bookingConfirmed: 'Bestätigte Buchungen',
      estimatedRevenue: 'Geschätzte Partnerprovision',
      confirmedRevenue: 'Bestätigte Partnerprovision',
      noCreatorData: 'Noch keine Creator-Daten vorhanden.',
      creatorPanelNote: 'Klicks auf Post-Widgets werden hier gemessen. Den Posts zugeordnete Verkäufe erscheinen hier, sobald Partnerdaten eintreffen.',
      creatorPanelBadge: 'Influencer-Vlogs'
    },
    es: {
      creatorPanelTitle: 'Rendimiento del creador',
      creatorPanelSubtitle: 'Aquí ves las interacciones generadas por tus posts influencer: impresiones de tarjeta, aperturas de popup, clics en widgets y conversiones atribuidas.',
      profileViews: 'Visitas del perfil',
      cardImpressions: 'Impresiones de tarjeta',
      postOpens: 'Aperturas del popup',
      widgetClicks: 'Clics en widgets',
      bookingPending: 'Reservas pendientes',
      bookingConfirmed: 'Reservas confirmadas',
      estimatedRevenue: 'Comisión partner estimada',
      confirmedRevenue: 'Comisión partner confirmada',
      noCreatorData: 'Todavía no hay datos del creador para mostrar.',
      creatorPanelNote: 'Los clics en los widgets del post se miden aquí. Las ventas atribuidas a los posts aparecerán aquí en cuanto lleguen los datos del partner.',
      creatorPanelBadge: 'Vlogs de influencers'
    },
    fr: {
      creatorPanelTitle: 'Performance créateur',
      creatorPanelSubtitle: 'Vous voyez ici les interactions générées par vos posts influenceur : impressions de carte, ouvertures du popup, clics widget et conversions attribuées.',
      profileViews: 'Vues du profil',
      cardImpressions: 'Impressions carte',
      postOpens: 'Ouvertures popup',
      widgetClicks: 'Clics widget',
      bookingPending: 'Réservations en attente',
      bookingConfirmed: 'Réservations confirmées',
      estimatedRevenue: 'Commission partenaire estimée',
      confirmedRevenue: 'Commission partenaire confirmée',
      noCreatorData: 'Aucune donnée créateur à afficher pour le moment.',
      creatorPanelNote: 'Les clics sur les widgets des posts sont mesurés ici. Les ventes attribuées aux posts apparaîtront ici dès réception des données partenaires.',
      creatorPanelBadge: 'Vlogs d’influenceurs'
    },
    nl: {
      creatorPanelTitle: 'Creator-prestaties',
      creatorPanelSubtitle: 'Hier zie je de interacties die door je influencer-posts zijn gegenereerd: kaartweergaven, popup-openingen, widgetklikken en toegeschreven conversies.',
      profileViews: 'Profielweergaven',
      cardImpressions: 'Kaartweergaven',
      postOpens: 'Popup-openingen',
      widgetClicks: 'Widgetklikken',
      bookingPending: 'Openstaande boekingen',
      bookingConfirmed: 'Bevestigde boekingen',
      estimatedRevenue: 'Geschatte partnercommissie',
      confirmedRevenue: 'Bevestigde partnercommissie',
      noCreatorData: 'Nog geen creator-gegevens om te tonen.',
      creatorPanelNote: 'Klikken op post-widgets worden hier gemeten. Aan posts toegewezen verkopen verschijnen hier zodra partnerdata binnenkomt.',
      creatorPanelBadge: 'Influencer-vlogs'
    },
    ru: {
      creatorPanelTitle: 'Статистика автора',
      creatorPanelSubtitle: 'Здесь показаны взаимодействия, которые принесли ваши посты: показы карточек, открытия попапов, клики по виджетам и атрибутированные конверсии.',
      profileViews: 'Просмотры профиля',
      cardImpressions: 'Показы карточек',
      postOpens: 'Открытия попапа',
      widgetClicks: 'Клики по виджету',
      bookingPending: 'Ожидающие бронирования',
      bookingConfirmed: 'Подтверждённые бронирования',
      estimatedRevenue: 'Оценочная комиссия партнёра',
      confirmedRevenue: 'Подтверждённая комиссия партнёра',
      noCreatorData: 'Пока нет данных креатора.',
      creatorPanelNote: 'Клики по виджетам в постах измеряются здесь. Продажи, привязанные к постам, появятся здесь после получения данных от партнёров.',
      creatorPanelBadge: 'Влоги инфлюенсеров'
    },
    ar: {
      creatorPanelTitle: 'أداء المنشئ',
      creatorPanelSubtitle: 'هنا ترى التفاعلات التي حققتها منشوراتك: مرات ظهور البطاقة، فتحات النافذة المنبثقة، نقرات الودجت والتحويلات المنسوبة.',
      profileViews: 'زيارات الملف',
      cardImpressions: 'مرات ظهور البطاقة',
      postOpens: 'مرات فتح المنشور',
      widgetClicks: 'نقرات الودجت',
      bookingPending: 'الحجوزات المعلقة',
      bookingConfirmed: 'الحجوزات المؤكدة',
      estimatedRevenue: 'عمولة الشريك التقديرية',
      confirmedRevenue: 'عمولة الشريك المؤكدة',
      noCreatorData: 'لا توجد بيانات منشئ للعرض حالياً.',
      creatorPanelNote: 'يتم قياس نقرات ودجت المنشورات هنا. ستظهر المبيعات المنسوبة إلى المنشورات هنا بمجرد وصول بيانات الشركاء.',
      creatorPanelBadge: 'مدونات المؤثرين'
    },
    zh: {
      creatorPanelTitle: '创作者表现',
      creatorPanelSubtitle: '这里会显示你的 Influencer 帖子带来的互动：卡片曝光、弹窗打开、组件点击以及归因转化。',
      profileViews: '资料浏览量',
      cardImpressions: '卡片曝光',
      postOpens: '弹窗打开',
      widgetClicks: '组件点击',
      bookingPending: '待处理预订',
      bookingConfirmed: '已确认预订',
      estimatedRevenue: '预估合作佣金',
      confirmedRevenue: '已确认合作佣金',
      noCreatorData: '暂时没有可显示的创作者数据。',
      creatorPanelNote: '帖子中的组件点击会在这里计量。归属于帖子的销售一旦从合作伙伴到达，就会显示在这里。',
      creatorPanelBadge: '达人旅行日志'
    }
  };

  function getCreatorDashboardLang(){
    try{
      var htmlLang = String(document.documentElement.getAttribute('lang') || 'it').toLowerCase();
      var supported = ['it','en','de','es','fr','nl','ru','ar','zh'];
      return supported.indexOf(htmlLang) !== -1 ? htmlLang : 'it';
    }catch(_e){
      return 'it';
    }
  }
  ...
  function cdText(key){
    var lang = getCreatorDashboardLang();
    return (CREATOR_DASHBOARD_I18N[lang] && CREATOR_DASHBOARD_I18N[lang][key]) || (CREATOR_DASHBOARD_I18N.it && CREATOR_DASHBOARD_I18N.it[key]) || key;
  }
  ...
  function init(){
    ...
    var elSalesMonth = $('#affiliate-stat-sales-month');
    ...
    var creatorStatsWrap = null;
    var creatorStatsEls = {};

    function ensureCreatorStatsWrap(){
      if (creatorStatsWrap) return creatorStatsWrap;
      if (!views.dashboard) return null;
      creatorStatsWrap = document.createElement('section');
      creatorStatsWrap.className = 'affiliate-influencer-card';
      creatorStatsWrap.id = 'affiliate-influencer-card';
      creatorStatsWrap.hidden = true;
      creatorStatsWrap.innerHTML = ''+
        '<div class="affiliate-influencer-card__header">'+
          '<span class="affiliate-influencer-card__badge">' + cdText('creatorPanelBadge') + '</span>'+
          '<h3 class="affiliate-influencer-card__title">' + cdText('creatorPanelTitle') + '</h3>'+
          '<p class="affiliate-influencer-card__subtitle">' + cdText('creatorPanelSubtitle') + '</p>'+
        '</div>'+
        '<div class="affiliate-stats-grid affiliate-stats-grid--creator">'+
          '<div class="stat-card"><div class="stat-label">' + cdText('profileViews') + '</div><div class="stat-value" data-creator-stat="profileViews">—</div></div>'+
          '<div class="stat-card"><div class="stat-label">' + cdText('cardImpressions') + '</div><div class="stat-value" data-creator-stat="cardImpressions">—</div></div>'+
          '<div class="stat-card"><div class="stat-label">' + cdText('postOpens') + '</div><div class="stat-value" data-creator-stat="postOpens">—</div></div>'+
          '<div class="stat-card"><div class="stat-label">' + cdText('widgetClicks') + '</div><div class="stat-value" data-creator-stat="widgetClicks">—</div></div>'+
          '<div class="stat-card"><div class="stat-label">' + cdText('bookingPending') + '</div><div class="stat-value" data-creator-stat="bookingPending">—</div></div>'+
          '<div class="stat-card"><div class="stat-label">' + cdText('bookingConfirmed') + '</div><div class="stat-value" data-creator-stat="bookingConfirmed">—</div></div>'+
          '<div class="stat-card"><div class="stat-label">' + cdText('estimatedRevenue') + '</div><div class="stat-value" data-creator-stat="estimatedRevenue">—</div></div>'+
          '<div class="stat-card"><div class="stat-label">' + cdText('confirmedRevenue') + '</div><div class="stat-value" data-creator-stat="confirmedRevenue">—</div></div>'+
        '</div>'+
        '<p class="affiliate-influencer-card__note muted small">' + cdText('creatorPanelNote') + '</p>';

      var insertAfter = $('.affiliate-stats-grid', views.dashboard) || $('.affiliate-id-block', views.dashboard) || $('.auth-card-header', views.dashboard);
      if (insertAfter && insertAfter.parentNode) {
        if (insertAfter.nextSibling) insertAfter.parentNode.insertBefore(creatorStatsWrap, insertAfter.nextSibling);
        else insertAfter.parentNode.appendChild(creatorStatsWrap);
      } else {
        views.dashboard.appendChild(creatorStatsWrap);
      }

      creatorStatsEls.profileViews = $('[data-creator-stat="profileViews"]', creatorStatsWrap);
      creatorStatsEls.cardImpressions = $('[data-creator-stat="cardImpressions"]', creatorStatsWrap);
      creatorStatsEls.postOpens = $('[data-creator-stat="postOpens"]', creatorStatsWrap);
      creatorStatsEls.widgetClicks = $('[data-creator-stat="widgetClicks"]', creatorStatsWrap);
      creatorStatsEls.bookingPending = $('[data-creator-stat="bookingPending"]', creatorStatsWrap);
      creatorStatsEls.bookingConfirmed = $('[data-creator-stat="bookingConfirmed"]', creatorStatsWrap);
      creatorStatsEls.estimatedRevenue = $('[data-creator-stat="estimatedRevenue"]', creatorStatsWrap);
      creatorStatsEls.confirmedRevenue = $('[data-creator-stat="confirmedRevenue"]', creatorStatsWrap);
      return creatorStatsWrap;
    }

    function renderCreatorStats(row){
      var wrap = ensureCreatorStatsWrap();
      if (!wrap) return;
      if (!row){
        wrap.hidden = true;
        return;
      ...
      wrap.hidden = false;
      if (creatorStatsEls.profileViews) creatorStatsEls.profileViews.textContent = String(row.profile_views || 0);
      if (creatorStatsEls.cardImpressions) creatorStatsEls.cardImpressions.textContent = String(row.card_impressions || 0);
      if (creatorStatsEls.postOpens) creatorStatsEls.postOpens.textContent = String(row.post_opens || 0);
      if (creatorStatsEls.widgetClicks) creatorStatsEls.widgetClicks.textContent = String(row.widget_clicks || 0);
      if (creatorStatsEls.bookingPending) creatorStatsEls.bookingPending.textContent = String(row.booking_pending || 0);
      if (creatorStatsEls.bookingConfirmed) creatorStatsEls.bookingConfirmed.textContent = String(row.booking_confirmed || 0);
      if (creatorStatsEls.estimatedRevenue) creatorStatsEls.estimatedRevenue.textContent = formatUsd(row.estimated_revenue_usd || 0);
      if (creatorStatsEls.confirmedRevenue) creatorStatsEls.confirmedRevenue.textContent = formatUsd(row.confirmed_revenue_usd || 0);
    }
  ...
  return;
    ...
    function renderChart(payouts){
      ...
      state.chart = new Chart(ctx, {
        ...
        data: {
          labels: labels,
          datasets: [{
            label: 'Ganancias mensuales acumuladas (USD)',
            data: values,
            tension: 0.25,
            fill: false
          }]
    ...
    function updatePayoutsTable(payouts){
      ...
      if (!payouts || !payouts.length){
        ...
        td0.textContent = 'Todavía no hay ganancias mensuales registradas.';
        tr0.appendChild(td0);
    ...
    async function loadDashboardStats(){
      ...
      try{
        ...
        var monthRowPromise = client
          .from('monthly_affiliate_stats')
          .select('sales_count,net_commissions')
          .eq('affiliate_slug', slug)
        ...
        var influencerStatsPromise = client
          .from('influencer_creator_private_stats')
          .select('affiliate_slug,profile_views,card_impressions,post_opens,widget_clicks,booking_pending,booking_confirmed,estimated_revenue_usd,confirmed_revenue_usd,available_balance')
          .eq('affiliate_slug', slug)
          .maybeSingle();
        ...
        var payoutsResp = getOk(1);
        var monthRowResp = getOk(2);
        var balanceResp = getOk(3);
        var payoutReqResp = getOk(4);
        var influencerStatsResp = getOk(5);
        ...
        if (elSalesMonth) elSalesMonth.textContent = String(salesCount);
        ...
        var creatorStats = (influencerStatsResp && !influencerStatsResp.error) ? (influencerStatsResp.data || null) : null;
        renderCreatorStats(creatorStats);
