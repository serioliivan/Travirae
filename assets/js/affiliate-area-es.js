...
(function(){
  ...
  const CREATOR_DASHBOARD_I18N = {
    it: {
      ...
      creatorPanelNote: 'I click sui widget dei post vengono registrati anche nella dashboard affiliato. Le vendite attribuite ai post saranno visibili qui appena arrivano dai partner.',
    ...
    en: {
      ...
      creatorPanelNote: 'Clicks on post widgets are also tracked in the affiliate dashboard. Sales attributed to posts will appear here as soon as partner data arrives.',
      creatorPanelBadge: 'Vlogs de influencers'
    },
    de: {
      ...
      confirmedRevenue: 'Bestätigter Umsatz',
      noCreatorData: 'Noch keine Creator-Daten vorhanden.',
      creatorPanelNote: 'Klicks auf Post-Widgets werden auch im Affiliate-Dashboard erfasst. Den Posts zugeordnete Verkäufe erscheinen hier, sobald die Partnerdaten ankommen.',
    ...
    es: {
      ...
      creatorPanelNote: 'Los clics en los widgets del post también se registran en el panel de afiliado. Las ventas atribuidas a los posts aparecerán aquí en cuanto lleguen los datos del partner.',
      creatorPanelBadge: 'Vlogs de influencers'
    },
    fr: {
      ...
      confirmedRevenue: 'Revenu confirmé',
      noCreatorData: 'Aucune donnée créateur à afficher pour le moment.',
      creatorPanelNote: 'Les clics sur les widgets des posts sont aussi suivis dans le tableau de bord affilié. Les ventes attribuées aux posts apparaîtront ici dès réception des données partenaires.',
    ...
    nl: {
      ...
      estimatedRevenue: 'Geschatte opbrengst',
      confirmedRevenue: 'Bevestigde opbrengst',
      noCreatorData: 'Nog geen creator-gegevens om te tonen.',
      creatorPanelNote: 'Klikken op post-widgets worden ook in het affiliate-dashboard geregistreerd. Aan posts toegewezen verkopen verschijnen hier zodra partnerdata binnenkomt.',
      creatorPanelBadge: 'Influencer-vlogs'
    },
    ru: {
      ...
      creatorPanelNote: 'Клики по виджетам в постах также учитываются в партнёрской панели. Продажи, привязанные к постам, появятся здесь после получения данных от партнёров.',
    ...
    ar: {
      ...
      estimatedRevenue: 'الإيراد التقديري',
      confirmedRevenue: 'الإيراد المؤكد',
      noCreatorData: 'لا توجد بيانات منشئ للعرض حالياً.',
      creatorPanelNote: 'يتم أيضاً تتبع النقرات على ودجت المنشورات داخل لوحة الشريك. ستظهر المبيعات المنسوبة إلى المنشورات هنا بمجرد وصول بيانات الشركاء.',
    ...
    zh: {
      ...
      confirmedRevenue: '确认收入',
      noCreatorData: '暂时没有可显示的创作者数据。',
      creatorPanelNote: '帖子中的组件点击也会记录到联盟后台。归属于帖子的销售一旦从合作伙伴到达，就会显示在这里。',
  ...
  return;
    ...
    async function loadDashboardStats(){
      ...
      try{
        ...
        var influencerStatsResp = getOk(6);
