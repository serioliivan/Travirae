...
(function(){
  ...
  var FINAL_LOCALE_PATCH_V51 = {
    ...
    es: {
      ...
      blockList: 'Lista con viñetas',
      blockQuote: 'Cita',
      blockTip: 'Consejo / Aviso',
      blockSeparator: 'Separador',
      blockStay22: 'Mapa de hoteles',
      blockAviasales: 'Widget de vuelos',
      widgetStay22Action: 'Abrir mapa de hoteles',
      widgetAviasalesAction: 'Abrir widget de vuelos',
      shareablePopup: 'Ventana compartible mediante URL',
      searchPosts: 'Buscar posts o creadores',
      searchPlaceholder: 'Buscar aquí…',
      noSearchResults: 'No hay resultados para tu búsqueda.',
      creatorLink: 'Abrir perfil del creador'
    ...
    fr: {
      ...
      blockList: 'Liste à puces',
      blockQuote: 'Citation',
      blockTip: 'Conseil / Encadré',
      blockSeparator: 'Séparateur',
      blockStay22: 'Carte hôtels',
      blockAviasales: 'Widget vols',
      widgetStay22Action: 'Ouvrir la carte hôtels',
      widgetAviasalesAction: 'Ouvrir le widget vols',
      shareablePopup: 'Popup partageable par URL',
      searchPosts: 'Rechercher des posts ou des créateurs',
      searchPlaceholder: 'Rechercher ici…',
      noSearchResults: 'Aucun résultat pour votre recherche.',
      creatorLink: 'Ouvrir le profil créateur'
    ...
    nl: {
      ...
      widgetAviasalesAction: 'Vluchten-widget openen',
      shareablePopup: 'Deelbare popup via URL',
      searchPosts: 'Posts of creators zoeken',
      searchPlaceholder: 'Hier zoeken…',
      noSearchResults: 'Geen resultaten voor je zoekopdracht.',
      creatorLink: 'Creatorprofiel openen'
    },
    ru: {
      blockHeading: 'Заголовок',
      blockParagraph: 'Абзац',
      ...
      widgetStay22Action: 'Открыть карту отелей',
      widgetAviasalesAction: 'Открыть виджет авиабилетов',
      shareablePopup: 'Всплывающее окно с URL для отправки',
      searchPosts: 'Искать посты или авторов',
      searchPlaceholder: 'Искать здесь…',
      noSearchResults: 'По вашему запросу ничего не найдено.',
      creatorLink: 'Открыть профиль автора'
    },
    ar: {
      ...
      blockSeparator: 'فاصل',
      blockStay22: 'خريطة الفنادق',
      blockAviasales: 'أداة الرحلات',
      widgetStay22Action: 'فتح خريطة الفنادق',
      widgetAviasalesAction: 'فتح أداة الرحلات',
      shareablePopup: 'نافذة قابلة للمشاركة عبر الرابط',
      searchPosts: 'ابحث عن المقالات أو صناع المحتوى',
      searchPlaceholder: 'ابحث هنا…',
      noSearchResults: 'لا توجد نتائج لعملية البحث.',
      creatorLink: 'فتح ملف صانع المحتوى'
    },
    zh: {
      blockHeading: '标题',
      blockParagraph: '段落',
      ...
      blockSeparator: '分隔线',
      blockStay22: '酒店地图',
      blockAviasales: '航班小组件',
      widgetStay22Action: '打开酒店地图',
      widgetAviasalesAction: '打开航班小组件',
      shareablePopup: '可通过链接分享的弹窗',
      searchPosts: '搜索文章或创作者',
      searchPlaceholder: '在此搜索…',
      noSearchResults: '没有找到匹配的结果。',
  ...
  Object.keys(FINAL_LOCALE_PATCH_V51).forEach(function(lang){
    STRINGS[lang] = Object.assign({}, STRINGS[lang] || {}, FINAL_LOCALE_PATCH_V51[lang]);
  });
