...
(function(){
  ...
  var DEFAULTS = {
    ...
    widgetStay22Action: 'Apri su Stay22',
  ...
  var EXTRA_STRINGS = {
    it: { blockHeading: 'Titolo', blockQuote: 'Citazione', blockStay22: 'Hotel Map', blockAviasales: 'Flights Widget', flightOriginLabel: 'Partenza', flightDestinationLabel: 'Destinazione', flightDepartLabel: 'Data partenza', flightReturnLabel: 'Ritorno', flightOriginPlaceholder: 'Città o codice IATA', flightDestinationPlaceholder: 'Città o codice IATA', flightSearchAction: 'Cerca voli' },
    en: { blockHeading: 'Heading', blockQuote: 'Quote', blockStay22: 'Hotel Map', blockAviasales: 'Flights Widget', flightOriginLabel: 'Origin', flightDestinationLabel: 'Destination', flightDepartLabel: 'Depart date', flightReturnLabel: 'Return date', flightOriginPlaceholder: 'City or IATA code', flightDestinationPlaceholder: 'City or IATA code', flightSearchAction: 'Search flights' },
    de: { blockHeading: 'Überschrift', blockQuote: 'Zitat', blockStay22: 'Hotel Map', blockAviasales: 'Flights Widget', flightOriginLabel: 'Abflug', flightDestinationLabel: 'Ziel', flightDepartLabel: 'Abflugdatum', flightReturnLabel: 'Rückflug', flightOriginPlaceholder: 'Stadt oder IATA-Code', flightDestinationPlaceholder: 'Stadt oder IATA-Code', flightSearchAction: 'Flüge suchen' },
    es: { blockHeading: 'Encabezado', blockQuote: 'Cita', blockStay22: 'Hotel Map', blockAviasales: 'Flights Widget', flightOriginLabel: 'Origen', flightDestinationLabel: 'Destino', flightDepartLabel: 'Fecha de salida', flightReturnLabel: 'Regreso', flightOriginPlaceholder: 'Ciudad o código IATA', flightDestinationPlaceholder: 'Ciudad o código IATA', flightSearchAction: 'Buscar vuelos' },
    fr: { blockHeading: 'Titre', blockQuote: 'Citation', blockStay22: 'Hotel Map', blockAviasales: 'Flights Widget', flightOriginLabel: 'Départ', flightDestinationLabel: 'Destination', flightDepartLabel: 'Date de départ', flightReturnLabel: 'Retour', flightOriginPlaceholder: 'Ville ou code IATA', flightDestinationPlaceholder: 'Ville ou code IATA', flightSearchAction: 'Rechercher des vols' },
    nl: { blockHeading: 'Kop', blockQuote: 'Citaat', blockStay22: 'Hotel Map', blockAviasales: 'Flights Widget', flightOriginLabel: 'Vertrek', flightDestinationLabel: 'Bestemming', flightDepartLabel: 'Vertrekdatum', flightReturnLabel: 'Terugreis', flightOriginPlaceholder: 'Stad of IATA-code', flightDestinationPlaceholder: 'Stad of IATA-code', flightSearchAction: 'Vluchten zoeken' },
    ru: { blockHeading: 'Заголовок', blockQuote: 'Цитата', blockStay22: 'Hotel Map', blockAviasales: 'Flights Widget', flightOriginLabel: 'Откуда', flightDestinationLabel: 'Куда', flightDepartLabel: 'Дата вылета', flightReturnLabel: 'Обратно', flightOriginPlaceholder: 'Город или код IATA', flightDestinationPlaceholder: 'Город или код IATA', flightSearchAction: 'Найти рейсы' },
    ar: { blockHeading: 'عنوان', blockQuote: 'اقتباس', blockStay22: 'Hotel Map', blockAviasales: 'Flights Widget', flightOriginLabel: 'المغادرة', flightDestinationLabel: 'الوجهة', flightDepartLabel: 'تاريخ المغادرة', flightReturnLabel: 'العودة', flightOriginPlaceholder: 'مدينة أو رمز IATA', flightDestinationPlaceholder: 'مدينة أو رمز IATA', flightSearchAction: 'ابحث عن رحلات' },
    zh: { blockHeading: '标题', blockQuote: '引用', blockStay22: 'Hotel Map', blockAviasales: 'Flights Widget', flightOriginLabel: '出发地', flightDestinationLabel: '目的地', flightDepartLabel: '出发日期', flightReturnLabel: '返程日期', flightOriginPlaceholder: '城市或 IATA 代码', flightDestinationPlaceholder: '城市或 IATA 代码', flightSearchAction: '搜索航班' }
  };
  Object.keys(EXTRA_STRINGS).forEach(function(lang){
    STRINGS[lang] = Object.assign({}, STRINGS[lang] || {}, EXTRA_STRINGS[lang]);
  });
  var TRANSLATION_FIXES = {
  "de": {
    "bookingPending": "Ausstehende Buchungen",
    "blockHeading": "Überschrift",
    "blockParagraph": "Absatz",
    "blockImage": "Bild",
    "blockList": "Aufzählung",
    "blockQuote": "Zitat",
    "blockTip": "Tipp / Hinweis",
    "blockSeparator": "Trenner",
    "blockStay22": "Hotelkarte",
    "blockAviasales": "Flug-Widget",
    ...
    "archive": "Archivieren",
    "logicalDelete": "Logisch löschen",
    "creators": "Creator",
    "emptyState": "Nichts anzuzeigen.",
    "queueProfiles": "Ausstehende Profile",
    "queuePosts": "Ausstehende Beiträge",
    "queueChanges": "Ausstehende Änderungen",
    "liveProfile": "Live-Profil",
    "pendingProfile": "Ausstehender Entwurf / Prüfung",
    "livePost": "Live-Beitrag",
    "pendingPost": "Ausstehender Beitrag",
    "socialInstagram": "Instagram",
    "socialTiktok": "TikTok",
    "socialYoutube": "YouTube",
    "socialFacebook": "Facebook",
    ...
    "socialWebsite": "Website / Blog",
    "socialX": "X",
    "creatorLink": "Creator-Profil öffnen",
    "widgetStay22Action": "Auf Stay22 öffnen",
    "widgetAviasalesAction": "Flug-Widget öffnen",
    "backToList": "Zur Liste",
    "shareablePopup": "Teilbares Popup per URL",
    "searchPosts": "Beiträge oder Creator suchen",
    "searchPlaceholder": "Hier suchen…",
    "noSearchResults": "Keine Ergebnisse für diese Suche."
  },
  "es": {
    "bookingPending": "Reservas pendientes",
    "bookingConfirmed": "Reservas confirmadas",
    ...
    "blockImage": "Imagen",
    "blockList": "Lista con viñetas",
    "blockQuote": "Cita",
    "blockTip": "Tip / Aviso",
    "blockSeparator": "Separador",
    "blockStay22": "Mapa de hoteles",
    "blockAviasales": "Widget de vuelos",
    "newPost": "Nuevo post",
    "editPost": "Editar post",
    "deletePost": "Eliminar post",
    "createFirstPost": "Crea tu primer post",
    "noPostsYet": "Todavía no has creado ningún post.",
    "status": "Estado",
    "live": "En vivo",
    "pending": "Pendiente",
    ...
    "archive": "Archivar",
    "logicalDelete": "Eliminación lógica",
    "creators": "Creadores",
    "emptyState": "No hay nada para mostrar.",
    "queueProfiles": "Perfiles pendientes",
    "queuePosts": "Posts pendientes",
    "queueChanges": "Cambios pendientes",
    "liveProfile": "Perfil en vivo",
    "pendingProfile": "Borrador / revisión pendiente",
    "livePost": "Post en vivo",
    "pendingPost": "Post pendiente",
    "socialInstagram": "Instagram",
    "socialTiktok": "TikTok",
    "socialYoutube": "YouTube",
    "socialFacebook": "Facebook",
    "socialPinterest": "Pinterest",
    "socialTelegram": "Telegram",
    "socialWebsite": "Sitio web / Blog",
    "socialX": "X",
    "creatorLink": "Abrir perfil del creador",
    "widgetStay22Action": "Abrir en Stay22",
    "widgetAviasalesAction": "Abrir widget de vuelos",
    "backToList": "Volver a la lista",
    "shareablePopup": "Popup compartible por URL",
    "searchPosts": "Buscar posts o creadores",
    "searchPlaceholder": "Buscar aquí…",
    "noSearchResults": "No hay resultados para tu búsqueda."
  },
  "fr": {
    "bookingPending": "Réservations en attente",
    "bookingConfirmed": "Réservations confirmées",
    ...
    "blockImage": "Image",
    "blockList": "Liste à puces",
    "blockQuote": "Citation",
    "blockTip": "Astuce / Encadré",
    "blockSeparator": "Séparateur",
    "blockStay22": "Carte hôtels",
    "blockAviasales": "Widget vols",
    "newPost": "Nouveau post",
    "editPost": "Modifier le post",
    "deletePost": "Supprimer le post",
    "createFirstPost": "Créez votre premier post",
    "noPostsYet": "Vous n'avez encore créé aucun post.",
    "status": "Statut",
    "live": "En ligne",
    "pending": "En attente",
    ...
    "archive": "Archiver",
    "logicalDelete": "Suppression logique",
    "creators": "Créateurs",
    "emptyState": "Rien à afficher.",
    "queueProfiles": "Profils en attente",
    "queuePosts": "Posts en attente",
    "queueChanges": "Modifications en attente",
    "liveProfile": "Profil en ligne",
    "pendingProfile": "Brouillon / révision en attente",
    "livePost": "Post en ligne",
    "pendingPost": "Post en attente",
    "socialInstagram": "Instagram",
    "socialTiktok": "TikTok",
    "socialYoutube": "YouTube",
    "socialFacebook": "Facebook",
    "socialPinterest": "Pinterest",
    "socialTelegram": "Telegram",
    "socialWebsite": "Site / Blog",
    "socialX": "X",
    "creatorLink": "Ouvrir le profil créateur",
    "widgetStay22Action": "Ouvrir sur Stay22",
    "widgetAviasalesAction": "Ouvrir le widget vols",
    "backToList": "Retour à la liste",
    "shareablePopup": "Popup partageable via URL",
    "searchPosts": "Rechercher des posts ou des créateurs",
    "searchPlaceholder": "Rechercher ici…",
    "noSearchResults": "Aucun résultat pour votre recherche."
  },
  "nl": {
    "loading": "Laden…",
    "noPosts": "Nog geen gepubliceerde berichten.",
    "noCreator": "Creator niet gevonden of niet gepubliceerd.",
    ...
    "page": "Pagina",
    "by": "door",
    "creatorPosts": "Gepubliceerde berichten",
    "publicProfile": "Openbaar profiel",
    "loadingCreator": "Creator-profiel laden…",
    "toastReview": "Je bericht wordt beoordeeld. Dit kan tot 48 werkuren duren.",
    "saveDraft": "Concept opslaan",
    "submitReview": "Ter beoordeling verzenden",
    "profileSaved": "Profiel opgeslagen.",
    "postSaved": "Concept opgeslagen.",
    "postDeleted": "Bericht logisch verwijderd.",
    "invalidSocial": "Een of meer social-links zijn ongeldig voor het vereiste domein.",
    "invalidImage": "Ongeldig afbeeldingsbestand. Gebruik JPG, PNG of WEBP tot 8 MB.",
    "loginRequired": "Je moet inloggen in het affiliategedeelte om deze sectie te openen.",
    "goToLogin": "Naar login",
    "cardImpressions": "Kaartvertoningen",
    "postOpens": "Post-popup-openingen",
    "widgetClicks": "Uitgaande widgetklikken",
    "bookingPending": "Openstaande boekingen",
    "bookingConfirmed": "Bevestigde boekingen",
    "estimatedRevenue": "Geschatte omzet",
    "confirmedRevenue": "Bevestigde omzet",
    "availableBalance": "Beschikbaar saldo",
    "profileViews": "Profielweergaven",
    "blockHeading": "Kop",
    "blockParagraph": "Alinea",
    "blockImage": "Afbeelding",
    "blockList": "Opsomming",
    "blockQuote": "Citaat",
    "blockTip": "Tip / Uitgelicht",
    "blockSeparator": "Scheiding",
    "blockStay22": "Hotelkaart",
    "blockAviasales": "Vluchten-widget",
    "newPost": "Nieuw bericht",
    "editPost": "Bericht bewerken",
    "deletePost": "Bericht verwijderen",
    "createFirstPost": "Maak je eerste bericht",
    "noPostsYet": "Je hebt nog geen berichten gemaakt.",
    "status": "Status",
    "live": "Live",
    ...
    "archive": "Archiveren",
    "logicalDelete": "Logisch verwijderen",
    "creators": "Creators",
    "emptyState": "Niets om te tonen.",
    "queueProfiles": "Profielen in afwachting",
    "queuePosts": "Berichten in afwachting",
    "queueChanges": "Wijzigingen in afwachting",
    "liveProfile": "Live-profiel",
    "pendingProfile": "Concept / beoordeling in afwachting",
    "livePost": "Live-bericht",
    "pendingPost": "Bericht in afwachting",
    "socialInstagram": "Instagram",
    "socialTiktok": "TikTok",
    "socialYoutube": "YouTube",
    "socialFacebook": "Facebook",
    ...
    "socialWebsite": "Website / Blog",
    "socialX": "X",
    "creatorLink": "Creator-profiel openen",
    "widgetStay22Action": "Openen op Stay22",
    "widgetAviasalesAction": "Vluchten-widget openen",
    "backToList": "Terug naar lijst",
    "shareablePopup": "Deelbare popup via URL",
    "searchPosts": "Zoek berichten of creators",
    "searchPlaceholder": "Zoek hier…",
    "noSearchResults": "Geen resultaten voor je zoekopdracht."
  },
  "ru": {
    "loading": "Загрузка…",
    "noPosts": "Пока нет опубликованных постов.",
    "noCreator": "Автор не найден или не опубликован.",
    ...
    "page": "Страница",
    "by": "от",
    "creatorPosts": "Опубликованные посты",
    "publicProfile": "Публичный профиль",
    "loadingCreator": "Загрузка профиля автора…",
    "toastReview": "Ваш пост находится на проверке. Обработка может занять до 48 рабочих часов.",
    "saveDraft": "Сохранить черновик",
    "submitReview": "Отправить на проверку",
    "profileSaved": "Профиль сохранён.",
    "postSaved": "Черновик сохранён.",
    "postDeleted": "Пост логически удалён.",
    "invalidSocial": "Одна или несколько социальных ссылок недопустимы для нужного домена.",
    "invalidImage": "Недопустимый файл изображения. Используйте JPG, PNG или WEBP до 8 МБ.",
    "loginRequired": "Чтобы открыть этот раздел, войдите в партнёрскую зону.",
    "goToLogin": "Перейти ко входу",
    "cardImpressions": "Показы карточки",
    "postOpens": "Открытия попапа поста",
    "widgetClicks": "Клики по виджетам",
    "bookingPending": "Ожидающие бронирования",
    "bookingConfirmed": "Подтверждённые бронирования",
    "estimatedRevenue": "Оценочный доход",
    ...
    "blockQuote": "Цитата",
    "blockTip": "Совет / выделение",
    "blockSeparator": "Разделитель",
    "blockStay22": "Карта отелей",
    "blockAviasales": "Виджет авиабилетов",
    "newPost": "Новый пост",
    "editPost": "Редактировать пост",
    "deletePost": "Удалить пост",
    "createFirstPost": "Создайте свой первый пост",
    "noPostsYet": "Вы ещё не создали ни одного поста.",
    "status": "Статус",
    "live": "В эфире",
    "pending": "В ожидании",
    ...
    "logicalDelete": "Логически удалить",
    "creators": "Авторы",
    "emptyState": "Нечего показывать.",
    "queueProfiles": "Профили на проверке",
    "queuePosts": "Посты на проверке",
    "queueChanges": "Изменения на проверке",
    "liveProfile": "Профиль в эфире",
    "pendingProfile": "Черновик / проверка",
    "livePost": "Пост в эфире",
    "pendingPost": "Пост на проверке",
    "socialInstagram": "Instagram",
    "socialTiktok": "TikTok",
    "socialYoutube": "YouTube",
    "socialFacebook": "Facebook",
    "socialPinterest": "Pinterest",
    "socialTelegram": "Telegram",
    "socialWebsite": "Сайт / Блог",
    "socialX": "X",
    "creatorLink": "Открыть профиль автора",
    "widgetStay22Action": "Открыть на Stay22",
    "widgetAviasalesAction": "Открыть виджет авиабилетов",
    "backToList": "Назад к списку",
    "shareablePopup": "Всплывающее окно по URL",
    "searchPosts": "Поиск по постам или авторам",
    "searchPlaceholder": "Искать здесь…",
    "noSearchResults": "По вашему запросу ничего не найдено."
  },
  "ar": {
    "loading": "جارٍ التحميل…",
    "noPosts": "لا توجد منشورات منشورة حالياً.",
    "noCreator": "لم يتم العثور على المنشئ أو لم يتم نشره.",
    ...
    "page": "الصفحة",
    "by": "بواسطة",
    "creatorPosts": "المنشورات المنشورة",
    "publicProfile": "الملف العام",
    "loadingCreator": "جارٍ تحميل ملف المنشئ…",
    "toastReview": "المنشور قيد المراجعة. قد تستغرق العملية حتى 48 ساعة عمل.",
    "saveDraft": "حفظ المسودة",
    "submitReview": "إرسال للمراجعة",
    "profileSaved": "تم حفظ الملف.",
    "postSaved": "تم حفظ المسودة.",
    "postDeleted": "تم حذف المنشور منطقياً.",
    "invalidSocial": "يوجد رابط أو أكثر من روابط التواصل غير صالح للنطاق المطلوب.",
    "invalidImage": "ملف الصورة غير صالح. استخدم JPG أو PNG أو WEBP حتى 8 ميغابايت.",
    "loginRequired": "يجب تسجيل الدخول إلى منطقة الشركاء للوصول إلى هذا القسم.",
    "goToLogin": "اذهب إلى تسجيل الدخول",
    "cardImpressions": "مرات ظهور البطاقة",
    "postOpens": "مرات فتح نافذة المنشور",
    "widgetClicks": "نقرات الويدجت الخارجية",
    "bookingPending": "الحجوزات المعلقة",
    "bookingConfirmed": "الحجوزات المؤكدة",
    ...
    "blockParagraph": "فقرة",
    "blockImage": "صورة",
    "blockList": "قائمة نقطية",
    "blockQuote": "اقتباس",
    "blockTip": "نصيحة / تنبيه",
    "blockSeparator": "فاصل",
    "blockStay22": "خريطة الفنادق",
    "blockAviasales": "ويدجت الرحلات",
    "newPost": "منشور جديد",
    "editPost": "تعديل المنشور",
    "deletePost": "حذف المنشور",
    "createFirstPost": "أنشئ أول منشور لك",
    "noPostsYet": "لم تقم بإنشاء أي منشورات بعد.",
    "status": "الحالة",
    "live": "مباشر",
    ...
    "archive": "أرشفة",
    "logicalDelete": "حذف منطقي",
    "creators": "المنشئون",
    "emptyState": "لا يوجد ما يمكن عرضه.",
    "queueProfiles": "ملفات قيد الانتظار",
    "queuePosts": "منشورات قيد الانتظار",
    "queueChanges": "تعديلات قيد الانتظار",
    "liveProfile": "الملف المباشر",
    "pendingProfile": "مسودة / مراجعة قيد الانتظار",
    "livePost": "المنشور المباشر",
    "pendingPost": "منشور قيد الانتظار",
    "socialInstagram": "Instagram",
    "socialTiktok": "TikTok",
    "socialYoutube": "YouTube",
    "socialFacebook": "Facebook",
    "socialPinterest": "Pinterest",
    "socialTelegram": "Telegram",
    "socialWebsite": "الموقع / المدونة",
    "socialX": "X",
    "creatorLink": "فتح ملف المنشئ",
    "widgetStay22Action": "افتح على Stay22",
    "widgetAviasalesAction": "فتح ويدجت الرحلات",
    "backToList": "العودة إلى القائمة",
    "shareablePopup": "نافذة قابلة للمشاركة عبر الرابط",
    "searchPosts": "ابحث في المنشورات أو المنشئين",
  ...
  "zh": {
    ...
    "creatorPosts": "已发布文章",
    "publicProfile": "公开资料",
    "loadingCreator": "正在加载创作者资料…",
    "toastReview": "你的文章正在审核中。处理可能需要最多 48 个工作小时。",
    "saveDraft": "保存草稿",
    "submitReview": "提交审核",
    "profileSaved": "资料已保存。",
    "postSaved": "草稿已保存。",
    "postDeleted": "文章已逻辑删除。",
    "invalidSocial": "一个或多个社交链接与要求的域名不匹配。",
    "invalidImage": "图片文件无效。请使用不超过 8MB 的 JPG、PNG 或 WEBP。",
    "loginRequired": "要访问此部分，你需要先登录联盟区域。",
    "goToLogin": "前往登录",
    "cardImpressions": "卡片展示次数",
    "postOpens": "文章弹窗打开次数",
    "widgetClicks": "外部组件点击次数",
    "bookingPending": "待处理预订",
    "bookingConfirmed": "已确认预订",
    "estimatedRevenue": "预计收益",
    "confirmedRevenue": "确认收益",
    ...
    "socialX": "X",
    "creatorLink": "打开创作者资料",
    "widgetStay22Action": "在 Stay22 打开",
    "widgetAviasalesAction": "打开航班组件",
    "backToList": "返回列表",
    "shareablePopup": "可通过链接分享的弹窗",
    "searchPosts": "搜索文章或创作者",
    "searchPlaceholder": "在此搜索…",
    "noSearchResults": "没有找到匹配的结果。"
  }
};
  Object.keys(TRANSLATION_FIXES).forEach(function(lang){
    STRINGS[lang] = Object.assign({}, STRINGS[lang] || {}, TRANSLATION_FIXES[lang]);
  });
  ...
  function sanitizeSeparatorSize(value){
    value = String(value || 'medium').toLowerCase().trim();
    return ['thin','medium','large','xlarge'].indexOf(value) !== -1 ? value : 'medium';
  }
  ...
  function buildAviasalesWidgetScriptUrl(config){
    ...
    if (originCode){
      ...
      // Keep the widget interactive without letting the provider auto-fill the departure city from IP.
      url.searchParams.set('origin', '');
      url.searchParams.set('origin_iata', '');
    }
    if (destinationCode){
      url.searchParams.set('destination', destinationCode);
      url.searchParams.set('destination_iata', destinationCode);
    } else if (Object.prototype.hasOwnProperty.call(config, 'destination')){
      url.searchParams.set('destination', '');
      url.searchParams.set('destination_iata', '');
    }
    if (config.departDate) url.searchParams.set('depart_date', String(config.departDate));
    if (config.returnDate) url.searchParams.set('return_date', String(config.returnDate));
    url.searchParams.set('one_way', config.returnDate ? 'false' : 'true');
  ...
  function renderAviasalesManualForm(config){
    config = config || {};
    var originValue = String(config.origin || '').trim();
    var destinationValue = String(config.destination || '').trim();
    var departValue = String(config.departDate || '').trim();
    var returnValue = String(config.returnDate || '').trim();
    var buttonLabel = String(config.ctaLabel || '').trim() || t('flightSearchAction') || t('widgetAviasalesAction');
    return '' +
      '<form class="if-flight-widget-preview if-flight-widget-preview--manual" data-if-aviasales-manual-form="1" data-widget-interactive="1" data-tracking-code="' + escapeAttr(config.trackingCode || '') + '" data-widget-locale="' + escapeAttr(config.locale || getLang()) + '">' +
        '<div class="if-flight-widget-preview__route">' +
          '<label class="if-flight-widget-preview__field if-flight-widget-preview__field--control">' +
            '<span class="if-flight-widget-preview__label">' + escapeHtml(t('flightOriginLabel')) + '</span>' +
            '<input type="text" autocomplete="off" data-if-avia-field="origin" value="' + escapeAttr(originValue) + '" placeholder="' + escapeAttr(t('flightOriginPlaceholder')) + '"/>' +
          '</label>' +
          '<div class="if-flight-widget-preview__arrow" aria-hidden="true">→</div>' +
          '<label class="if-flight-widget-preview__field if-flight-widget-preview__field--control">' +
            '<span class="if-flight-widget-preview__label">' + escapeHtml(t('flightDestinationLabel')) + '</span>' +
            '<input type="text" autocomplete="off" data-if-avia-field="destination" value="' + escapeAttr(destinationValue) + '" placeholder="' + escapeAttr(t('flightDestinationPlaceholder')) + '"/>' +
          '</label>' +
        '</div>' +
        '<div class="if-flight-widget-preview__dates if-flight-widget-preview__dates--manual">' +
          '<label class="if-flight-widget-preview__field if-flight-widget-preview__field--control">' +
            '<span class="if-flight-widget-preview__label">' + escapeHtml(t('flightDepartLabel')) + '</span>' +
            '<input type="date" data-if-avia-field="departDate" value="' + escapeAttr(departValue) + '"/>' +
          '</label>' +
          '<label class="if-flight-widget-preview__field if-flight-widget-preview__field--control">' +
            '<span class="if-flight-widget-preview__label">' + escapeHtml(t('flightReturnLabel')) + '</span>' +
            '<input type="date" data-if-avia-field="returnDate" value="' + escapeAttr(returnValue) + '"/>' +
          '</label>' +
        '</div>' +
        '<button class="btn if-flight-widget-preview__submit" type="submit" data-widget-interactive="1">' + escapeHtml(buttonLabel) + '</button>' +
      '</form>';
  }
  function getAviasalesManualField(form, name){
    var el = form ? $('[data-if-avia-field="' + name + '"]', form) : null;
    return el ? String(el.value || '').trim() : '';
  }
  function bindAviasalesManualForms(root){
    var scope = root || document;
    $all('[data-if-aviasales-manual-form="1"]', scope).forEach(function(form){
      if (!form || form.__ifAviaManualBound) return;
      form.__ifAviaManualBound = true;
      form.addEventListener('submit', function(e){
        e.preventDefault();
        var trackingCode = String(form.getAttribute('data-tracking-code') || '').trim();
        var locale = String(form.getAttribute('data-widget-locale') || getLang()).trim();
        var href = buildAviasalesUrl({
          trackingCode: trackingCode,
          origin: getAviasalesManualField(form, 'origin'),
          destination: getAviasalesManualField(form, 'destination'),
          departDate: getAviasalesManualField(form, 'departDate'),
          returnDate: getAviasalesManualField(form, 'returnDate'),
          locale: locale
        });
        var widgetRoot = form.closest ? form.closest('[data-widget-track-root="1"]') : null;
        if (widgetRoot) registerWidgetInteraction(widgetRoot);
        var opened = null;
        try{
          opened = window.open(href, '_blank');
          if (opened){ try{ opened.opener = null; }catch(_opener){} return; }
        }catch(_){ opened = null; }
        window.location.href = href;
      });
    });
  }
  function readAviasalesUrlParam(src, name){
    try{ return new URL(src || '', window.location.href).searchParams.get(name) || ''; }catch(_){ return ''; }
  }
  function replaceLegacyEmptyOriginAviasalesWidgets(root){
    var scope = root || document;
    $all('[data-if-aviasales-widget][data-empty-origin="1"]', scope).forEach(function(host){
      if (!host || host.__ifEmptyOriginReplaced) return;
      host.__ifEmptyOriginReplaced = true;
      var src = host.getAttribute('data-widget-src') || '';
      var widgetRoot = host.closest ? host.closest('[data-widget-track-root="1"]') : null;
      var fields = $all('.if-flight-widget-preview__field', host);
      var destinationText = fields.length > 1 ? String(fields[1].textContent || '').trim() : '';
      host.classList.add('if-aviasales-widget-host--manual');
      host.removeAttribute('data-if-aviasales-widget');
      host.removeAttribute('data-widget-src');
      host.removeAttribute('data-hydrated-src');
      host.innerHTML = renderAviasalesManualForm({
        trackingCode: readAviasalesUrlParam(src, 'sub_id') || (widgetRoot ? String(widgetRoot.getAttribute('data-tracking-code') || '') : ''),
        origin: '',
        destination: destinationText || readAviasalesUrlParam(src, 'destination') || readAviasalesUrlParam(src, 'destination_iata'),
        departDate: readAviasalesUrlParam(src, 'depart_date'),
        returnDate: readAviasalesUrlParam(src, 'return_date'),
        locale: readAviasalesUrlParam(src, 'locale') || getLang(),
        ctaLabel: t('flightSearchAction')
      });
    });
  }
  ...
  function isVisibleFormControl(el){
    if (!el) return false;
  ...
  function clearAviasalesGeneratedOrigin(host){
    if (!host || host.getAttribute('data-empty-origin') !== '1') return;
    var mount = $('[data-if-aviasales-mount]', host);
    if (!mount) return;
    var inputs = $all('input, textarea', mount).filter(isVisibleFormControl);
    if (!inputs.length) return;
    var originInput = inputs[0];
    try{
      if (originInput.value){
        originInput.value = '';
        originInput.setAttribute('value', '');
        originInput.dispatchEvent(new Event('input', { bubbles: true }));
        originInput.dispatchEvent(new Event('change', { bubbles: true }));
      }
      originInput.setAttribute('placeholder', originInput.getAttribute('placeholder') || '');
    }catch(_){ }
    try{
      var container = originInput.parentElement;
      for (var depth = 0; container && depth < 3; depth += 1){
        var visibleFields = $all('input, textarea', container).filter(isVisibleFormControl);
        if (visibleFields.length > 1) break;
        $all('span,small,strong,b,em,button', container).forEach(function(node){
          var text = String(node.textContent || '').trim();
          if (/^[A-Z]{3}$/.test(text)) node.textContent = '';
        });
        container = container.parentElement;
      }
    }catch(_){ }
  }
  function scheduleAviasalesOriginCleanup(host){
    if (!host || host.getAttribute('data-empty-origin') !== '1') return;
    [0, 120, 450, 900, 1600, 2800].forEach(function(delay){
      window.setTimeout(function(){ clearAviasalesGeneratedOrigin(host); }, delay);
    });
  }
  function hydrateAviasalesWidgets(root){
    ...
    $all('[data-if-aviasales-widget]', scope).forEach(function(host){
      ...
      if (host.getAttribute('data-hydrated-src') === src && hasAviasalesWidgetRendered(mount)){
        ...
        scheduleAviasalesOriginCleanup(host);
        return;
      }
  ...
  function hydrateWidgetEmbeds(root){
    var scope = root || document;
    replaceLegacyEmptyOriginAviasalesWidgets(scope);
    hydrateAviasalesWidgets(scope);
    bindAviasalesManualForms(scope);
  }

  function registerWidgetInteraction(widgetRoot){
    if (!widgetRoot) return;
    var partner = String(widgetRoot.getAttribute('data-partner') || '').trim() || 'unknown';
    var trackingCode = String(widgetRoot.getAttribute('data-tracking-code') || '').trim();
    var widgetShortId = String(widgetRoot.getAttribute('data-widget-short-id') || '').trim();
    var creatorSlug = String(widgetRoot.getAttribute('data-creator-affiliate-slug') || widgetRoot.getAttribute('data-creator-slug') || '').trim();
    var creatorPublicSlug = String(widgetRoot.getAttribute('data-creator-public-slug') || '').trim();
    var postId = String(widgetRoot.getAttribute('data-post-id') || '').trim();
    var postSlug = String(widgetRoot.getAttribute('data-post-slug') || '').trim();
    if (!creatorSlug || !trackingCode || !postSlug) return;
    trackEvent({
      post_id: postId || null,
      affiliate_slug: creatorSlug,
      event_type: 'widget_click',
      partner: partner,
      widget_id: widgetShortId || null,
      metadata: {
        source: 'influencer_post',
        creator_slug: creatorPublicSlug || null,
        creator_affiliate_slug: creatorSlug,
        post_slug: postSlug || null,
        tracking_code: trackingCode || null
      }
    }, 'widget_' + (trackingCode || (postId + '_' + widgetShortId)), 1000 * 60 * 30);
  }
    ...
    $all(selector, scope).forEach(function(el){
      ...
      ['touchstart','pointerdown','mousedown'].forEach(function(evt){
        el.addEventListener(evt, function(){
          engageLock();
          var widgetRoot = el.closest ? el.closest('[data-widget-track-root="1"]') : null;
          if (widgetRoot) registerWidgetInteraction(widgetRoot);
        }, { passive: true });
      });
  ...
  function normalizeContentBlocks(blocks, context){
    ...
    (Array.isArray(blocks) ? blocks : []).forEach(function(raw){
      ...
      if (block.type === 'heading'){
        ...
        block.text = '';
        block.size = sanitizeSeparatorSize(block.size || 'medium');
  ...
  function renderWidgetCard(block, context){
    ...
    var creatorAffiliateSlug = String(context.creatorSlug || post.creator_affiliate_slug || post.creator_slug || '').trim();
    var creatorPublicSlug = String((post && post.creator_slug) || '').trim();
    var trackingCode = block.trackingCode || buildWidgetTrackingCode(creatorAffiliateSlug, context.postShortId, block.widgetShortId);
    ...
    if (block.partner === 'stay22' && block.destination){
      ...
      var originDisplay = hasFlightOrigin ? formatAirportDisplay(block.origin) : '';
      var destinationDisplay = block.destination ? formatAirportDisplay(block.destination) : '';
      if (!hasFlightOrigin){
        // Aviasales auto-fills the departure city from the visitor IP when no origin is passed.
        // In that case we render a local interactive search form, so the origin stays truly blank.
        embedHtml = '' +
          '<div class="if-widget-card__embed if-widget-card__embed--aviasales" data-widget-interactive="1">' +
            '<div class="if-aviasales-widget-host if-aviasales-widget-host--manual" data-empty-origin="1" data-widget-interactive="1">' +
              renderAviasalesManualForm({ trackingCode: trackingCode, origin: '', destination: destinationDisplay, departDate: block.checkin, returnDate: block.returnDate, locale: block.widgetLocale, ctaLabel: block.ctaLabel }) +
            '</div>' +
          '</div>';
      } else {
            ...
            '<div class="if-aviasales-widget-host" data-if-aviasales-widget="1" data-widget-src="' + escapeAttr(aviaWidgetSrc) + '" data-widget-interactive="1">' +
              '<div class="if-aviasales-widget-fallback" data-if-aviasales-fallback="1">' +
                '<div class="if-flight-widget-preview">' +
                  '<div class="if-flight-widget-preview__route">' +
                    '<div class="if-flight-widget-preview__field"><span class="muted small">' + escapeHtml(originDisplay) + '</span></div>' +
                    '<div class="if-flight-widget-preview__arrow">→</div>' +
                    '<div class="if-flight-widget-preview__field"><span class="muted small">' + escapeHtml(destinationDisplay) + '</span></div>' +
                  '</div>' +
    ...
    var ctaHtml = '';
    if (block.partner === 'stay22' && href){
      ctaHtml = '<div class="if-widget-card__actions"><a class="btn secondary if-widget-card__cta" href="' + escapeAttr(href) + '" target="_blank" rel="noopener" data-widget-click="1" data-partner="stay22" data-tracking-code="' + escapeAttr(trackingCode) + '" data-widget-short-id="' + escapeAttr(block.widgetShortId || '') + '" data-creator-slug="' + escapeAttr(creatorAffiliateSlug) + '" data-post-id="' + escapeAttr(context.postId || post.post_id || '') + '" data-post-slug="' + escapeAttr(context.postSlug || post.post_slug || '') + '">' + escapeHtml(block.ctaLabel || t('widgetStay22Action')) + '</a></div>';
    }
    return '' +
      '<section class="if-widget-card if-widget-card--' + escapeAttr(block.partner) + '" data-widget-wrap="1" data-widget-track-root="1" data-partner="' + escapeAttr(block.partner) + '" data-tracking-code="' + escapeAttr(trackingCode) + '" data-widget-short-id="' + escapeAttr(block.widgetShortId || '') + '" data-creator-affiliate-slug="' + escapeAttr(creatorAffiliateSlug) + '" data-creator-public-slug="' + escapeAttr(creatorPublicSlug) + '" data-post-id="' + escapeAttr(context.postId || post.post_id || '') + '" data-post-slug="' + escapeAttr(context.postSlug || post.post_slug || '') + '">' +
  ...
  function renderContentHtml(blocks, context){
    ...
    return normalized.map(function(block){
      ...
      if (block.type === 'separator') return '<hr class="if-rich-separator is-separator-' + escapeAttr(sanitizeSeparatorSize(block.size || 'medium')) + '"/>';
  ...
  function applyCreatorPostAffiliateSession(post, options){
    options = options || {};
    if (!post) return false;
    var affiliateSlug = String(post.creator_affiliate_slug || post.creator_slug || '').trim();
    if (!affiliateSlug) return false;
    try{
      if (window.traviraeAffiliate && typeof window.traviraeAffiliate.setFromCreatorPost === 'function') {
        return window.traviraeAffiliate.setFromCreatorPost(affiliateSlug, {
          postSlug: post.post_slug || '',
          postId: post.post_id || '',
          creatorSlug: post.creator_slug || '',
          logLanding: !!options.logLanding
        });
      }
    }catch(_err){}
    try{
      if (window.sessionStorage) {
        sessionStorage.setItem('tva_session_ref', affiliateSlug.replace(/[^a-zA-Z0-9_-]/g, ''));
        sessionStorage.setItem('tva_session_ref_source', 'creator_post');
        sessionStorage.setItem('tva_session_ref_context', 'creator_post');
        if (post.post_slug) sessionStorage.setItem('tva_session_ref_post_slug', String(post.post_slug).replace(/[^a-zA-Z0-9_-]/g, ''));
        return true;
      }
    }catch(_err2){}
    return false;
  ...
  function initPublicPage(){
    ...
    function bindPublicSearchInput(input){
      ...
      input.addEventListener('keyup', function(ev){
        if (ev && ev.key === 'Enter') applySearch();
      });
    ...
    function renderModalPost(post){
      ...
      var contentHtml = (Array.isArray(contentBlocks) && contentBlocks.length)
        ...
        : (post.content_html || '');
      var shareUrl = new URL(window.location.origin + window.location.pathname);
    ...
    async function openPost(slug, pushState){
      ...
      state.postSlug = slug;
      applyCreatorPostAffiliateSession(post, {
        logLanding: !pushState && String(readQueryParam('post') || '') === String(slug || '')
      });
  ...
  function defaultBlock(type){
    ...
    if (type === 'separator') return { id: randomId('blk_'), type: 'separator', size: 'medium' };
