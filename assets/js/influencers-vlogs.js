...
(function(){
  ...
  function renderWidgetCard(block, context){
    ...
    if (block.partner === 'stay22' && block.destination){
      ...
      var aviaWidgetSrc = hasFlightOrigin ? buildAviasalesWidgetScriptUrl({ trackingCode: trackingCode, origin: block.origin, destination: block.destination, departDate: block.checkin, returnDate: block.returnDate, locale: block.widgetLocale }) : '';
      ...
      embedHtml = '' +
        '<div class="if-widget-card__embed if-widget-card__embed--aviasales" data-widget-interactive="1">' +
          '<div class="if-aviasales-widget-host"' + (hasFlightOrigin ? ' data-if-aviasales-widget="1" data-widget-src="' + escapeAttr(aviaWidgetSrc) + '"' : ' data-if-aviasales-static="1"') + ' data-widget-interactive="1">' +
            '<div class="if-aviasales-widget-fallback" data-if-aviasales-fallback="1">' +
              ...
              '</div>' +
            '</div>' +
            (hasFlightOrigin ? '<div class="if-aviasales-widget-mount" data-if-aviasales-mount="1" data-widget-interactive="1"></div>' : '') +
          '</div>' +
        '</div>';
    }
    var ctaHtml = '';
