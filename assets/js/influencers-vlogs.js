...
(function(){
  ...
  "de": {
    ...
    "widgetStay22Action": "Hotelkarte öffnen",
  ...
  "es": {
    ...
    "widgetStay22Action": "Abrir mapa de hoteles",
  ...
  "fr": {
    ...
    "widgetStay22Action": "Ouvrir la carte hôtels",
  ...
  "nl": {
    ...
    "widgetStay22Action": "Hotelkaart openen",
  ...
  "ru": {
    ...
    "widgetStay22Action": "Открыть карту отелей",
  ...
  "ar": {
    ...
    "widgetStay22Action": "فتح خريطة الفنادق",
    ...
    if (window.traviraeAffiliate && typeof window.traviraeAffiliate.trackBookingClick === 'function'){
      try{
        window.traviraeAffiliate.trackBookingClick({
          ...
          source: 'influencer_post',
          widgetTrackingCode: trackingCode,
