    ...
    if (block.partner === 'stay22' && block.destination){
      ...
      embedHtml = '' +
        '<div class="if-widget-card__embed if-widget-card__embed--aviasales" data-widget-interactive="1">' +
          '<div class="if-aviasales-widget-host" data-if-aviasales-widget="1" data-widget-src="' + escapeAttr(aviaWidgetSrc) + '"' + (!hasFlightOrigin ? ' data-empty-origin="1"' : '') + ' data-widget-interactive="1">' +
