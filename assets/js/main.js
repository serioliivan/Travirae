...
(function(){
  ...
  function logLandingClick(id){
    if (!id){
      if (window.console && console.warn) console.warn('Travirae: logLandingClick chiamato senza affiliate ID');
      return;
    }
    if (hasTrackedLanding(id)){
      if (window.console && console.log) console.log('Travirae: landing già tracciata per', id);
      return;
    }
      ...
      window.supabaseClient
        ...
        .then(function(res){
          if (res && res.error && window.console && console.warn){
            ...
            console.log('Travirae: landing affiliato registrata', payload);
          }
        })
        .catch(function(err){
