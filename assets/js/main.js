// Front-end (V6+) — robust proxy negotiation
...
window.__TRAVIRAE__={ setBase:(b,style='api')=>{ CFG.API_BASE_EFFECTIVE=b; CFG.API_STYLE=style; notify('Base impostata: '+b+' ('+style+')'); } };
...
async function initStays(){
  try{
    ...
    form.addEventListener('submit', async e=>{ e.preventDefault(); const city=$('#stay-city').value.trim(); const ci=$('#stay-in').value; const co=$('#stay-out').value; let lat='41.9028',lng='12.4964';
