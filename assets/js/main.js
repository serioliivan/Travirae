...
// === Travirae affiliate tracking (global ?ref handler) ===
(function(){
  ...
  if(ref){
    storeAffiliate(ref);
    // Track click into Supabase, if available
    try {
      if(window.supabaseClient && typeof window.supabaseClient.from === 'function'){
        ...
        window.supabaseClient
          ...
          .insert(payload)
          .then(function(res){ /* optional: inspect res */ })
          .catch(function(err){ if(window.console && console.warn) console.warn('Errore tracking affiliato', err); });
      }
    } catch(e){
