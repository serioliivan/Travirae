...
function stripEmojis(str){
  if(!str) return str;
  // Remove emoji ranges and pictographs (broad regex that works across modern browsers)
  return str
...
// Remove emojis from headings inside popups/dialogs when they appear
...
document.addEventListener('DOMContentLoaded', ()=>{
  sanitizePopupTitles();
  // Watch for dynamically created popups
...
(function(){
  ...
  document.addEventListener('click', (ev)=>{
    ...
    titleEl.textContent = stripEmojis(catchyTagline(category, city));
