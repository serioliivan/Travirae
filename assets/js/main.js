    ...
    try {
      if (window.supabaseClient && typeof window.supabaseClient.from === 'function'){
        ...
        window.supabaseClient
          ...
          .catch(function(err){
            if (window.console && console.warn) console.warn('Errore tracking affiliato', err);
          });
      }
    } catch(e){
      if (window.console && console.warn) console.warn('Errore tracking affiliato', e);
    }
  }
  ...
  window.traviraeAffiliate.trackBookingClick = function(partner){
    try {
      ...
      window.supabaseClient
        .from('bookings')
        .insert(payload)
        .then(function(res){ /* opzionale: console.log('booking click registrato'); */ })
        .catch(function(err){
          if (window.console && console.warn) console.warn('Errore registrazione booking click', err);
        });
    } catch(e){
      if (window.console && console.warn) console.warn('Errore trackBookingClick', e);
    }
  };
})();
