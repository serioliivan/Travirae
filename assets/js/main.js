...
(function(){
  ...
  const FLAG = {
    ...
    'paesi bassi':'🇳🇱','olanda':'🇳🇱','belgio':'🇧🇪','lussemburgo':'🇱🇺','andorra':'🇦🇩','monaco':'🇲🇨','portogallo':'🇵🇹',
    'polonia':'🇵🇱','repubblica ceca':'🇨🇿','cechia':'🇨🇿','slovacchia':'🇸🇰','slovenia':'🇸🇮','croazia':'🇭🇷','serbia':'🇷🇸','bosnia':'🇧🇦',
    'montenegro':'🇲🇪','albania':'🇦🇱','romania':'🇷🇴','bulgaria':'🇧🇬','macedonia':'🇲🇰','cipro':'🇨🇾','malta':'🇲🇹',
    // Americas
    ...
    'costa rica':'🇨🇷','colombia':'🇨🇴','peru':'🇵🇪','cile':'🇨🇱','argentina':'🇦🇷','brasile':'🇧🇷','uruguay':'🇺🇾','bolivia':'🇧🇴','ecuador':'🇪🇨',
    // Africa & Middle East
    ...
    'india':'🇮🇳','sri lanka':'🇱🇰','nepal':'🇳🇵','kazakistan':'🇰🇿','uzbekistan':'🇺🇿','kirghizistan':'🇰🇬',
