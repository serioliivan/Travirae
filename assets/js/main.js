...
(function(){
  ...
  ,
    'capodanno-sulla-neve':'new year,snow resort,fireworks'
  ,
    'compleanno':'birthday trip,celebration,nightlife'
  ,
    'da-solo':'solo traveler,scenic,road trip'
  ,
    'coppia':'romantic couple,sunset,beach'
  ,
    'famiglia-con-bambini-piccoli':'family travel,beach,kids playing'
  ,
    'famiglia-con-ragazzi-grandi':'family adventure,teens,hiking'
  ,
    'gruppo-di-ragazzi-giovani':'friends travel,beach party,nightlife'
  ,
    'gruppo-di-amici':'group of friends,travel,adventure'
  ,
    'meno-di-99':'budget travel,city break,street'
  ,
