  ...
  function initNewsletterSignup(){
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try{
        ...
        showToast((lang === 'DEU') ? 'Abo bestätigt! Danke.' : ((lang === 'ENG') ? 'Subscription confirmed. Thank you.' : ((lang === 'FRA') ? 'Inscription confirmée. Merci.' : 'Iscrizione completata! Grazie.')), 'success');
      } catch (err){
        showToast((lang === 'DEU') ? 'Fehler bei der Anmeldung. Bitte versuche es später erneut.' : ((lang === 'ENG') ? 'Subscription failed. Please try again later.' : ((lang === 'FRA') ? 'Erreur lors de l’inscription. Réessaie plus tard.' : 'Errore durante iscrizione. Riprova tra poco.')), 'error');
