...
(function(){
  ...
  const makeCopy = (name) => {
    ...
    return {
      desc: `${name} è una scelta top per un viaggio memorabile: atmosfera locale, panorami e esperienze autentiche. Ideale per 3–5 giorni, ma anche per un soggiorno più lungo se vuoi esplorare con calma. ✨`,
      bullets: ['Quartieri imperdibili e viewpoint','Musei/luoghi simbolo da vedere','Cibo tipico e mercati locali','Gite/escursioni a breve raggio'],
      when: 'Periodo consigliato: in genere da fine primavera a inizio autunno; per mare o neve varia a seconda della destinazione.',
      bonus: 'Bonus: prenota in settimana per prezzi migliori e orari più comodi.'
    };
  };
  ...
  function openModal(city){
    ...
    whenEl.innerHTML = `📅 <strong>${copy.when}</strong>`;
