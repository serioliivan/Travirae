...
(function(){
  ...
  document.querySelectorAll('.accordion-toggle.category').forEach(btn=>{
    ...
    if(explicit){ tryURL(explicit, ()=>tryURL(local, ()=>tryURL(unsplash, ()=>setBG('assets/img/common/hero.jpg')))); }
    else { tryURL(local, ()=>tryURL(unsplash, ()=>setBG('assets/img/common/hero.jpg'))); }
  });
}
