...
// Assign visible background images to category tiles.
// This uses placeholders; replace URLs with the final ones when provided.
(function(){
  try{
    var CATEGORY_BACKGROUNDS = {
  "Mare": "assets/img/common/hero.jpg",
  "Montagna": "assets/img/common/hotel-bg.jpg",
  "Lago": "assets/img/common/hero.jpg",
  "Isole": "assets/img/common/hero.jpg",
  "Cultura": "assets/img/common/hotel-bg.jpg",
  "Relax": "assets/img/common/flights-bg.jpg",
  "Città": "assets/img/common/hotel-bg.jpg",
  "Safari": "assets/img/common/flights-bg.jpg",
  "Esotici": "assets/img/common/flights-bg.jpg",
  "Natura": "assets/img/common/flights-bg.jpg",
  "Destinazioni popolari": "assets/img/common/hotel-bg.jpg",
  "Fuga romantica": "assets/img/common/flights-bg.jpg",
  "Anniversario": "assets/img/common/hero.jpg",
  "Luna di miele": "assets/img/common/hotel-bg.jpg",
  "Addio celibato": "assets/img/common/flights-bg.jpg",
  "Capodanno caldo": "assets/img/common/hero.jpg",
  "Capodanno sulla neve": "assets/img/common/hotel-bg.jpg",
  "Compleanno": "assets/img/common/flights-bg.jpg",
  "Da solo": "assets/img/common/hero.jpg",
  "Coppia": "assets/img/common/hotel-bg.jpg",
  "Famiglia con bambini piccoli": "assets/img/common/flights-bg.jpg",
  "Famiglia con ragazzi grandi": "assets/img/common/hero.jpg",
  "Gruppo di ragazzi giovani": "assets/img/common/hotel-bg.jpg",
  "Gruppo di amici": "assets/img/common/flights-bg.jpg",
  "Meno di 99€": "assets/img/common/hero.jpg",
  "Low Cost": "assets/img/common/hotel-bg.jpg",
  "Premium": "assets/img/common/hotel-bg.jpg",
  "Luxury": "assets/img/common/hotel-bg.jpg",
  "Estate": "assets/img/common/hotel-bg.jpg",
  "Primavera": "assets/img/common/hotel-bg.jpg",
  "Autunno": "assets/img/common/hotel-bg.jpg",
  "Inverno": "assets/img/common/hotel-bg.jpg",
  "Snowboard": "assets/img/common/flights-bg.jpg",
  "Sci": "assets/img/common/flights-bg.jpg",
  "Trekking": "assets/img/common/flights-bg.jpg",
  "Arrampicata": "assets/img/common/flights-bg.jpg",
  "Ciclismo": "assets/img/common/flights-bg.jpg",
  "Surf": "assets/img/common/hero.jpg",
  "Immersioni": "assets/img/common/hero.jpg",
  "Snorkeling": "assets/img/common/hero.jpg",
  "Golf": "assets/img/common/flights-bg.jpg"
};
    document.querySelectorAll('.accordion-toggle.category').forEach(function(btn){
      ...
      var url = CATEGORY_BACKGROUNDS[name] || CATEGORY_BACKGROUNDS[name.toLowerCase()] || null;
      if(url){
        // Set via CSS variable so CSS can apply with background-image
        btn.style.setProperty('--category-bg', 'url("' + url + '")');
      }
    });
  }catch(e){ console.error('category backgrounds init error', e); }
})();
