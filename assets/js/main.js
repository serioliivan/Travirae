(function(){
  ...
  function initHero(){
    ...
    if(layer) setBg(layer, cfg.HERO_IMAGE_LOCAL || 'assets/img/hero.jpg');
  }

  // In case any destination image fails, set a neutral placeholder
