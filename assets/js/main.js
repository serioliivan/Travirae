...
(function(){
  ...
  window.traviraeAffiliate.trackBookingClick = function(partner){
    try{
      ...
      // Se non c'è un parametro ?ref e nessun id salvato, consideriamo la visita "direct".
      // In questo modo l'admin può vedere i booking click totali (affiliati + diretti).
      var id = window.traviraeAffiliate.getId() || 'direct';
