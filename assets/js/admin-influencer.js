...
(function(){
    ...
    view.innerHTML = '' +
      '<div class="if-admin-shell if-admin-shell--accordion">' +
        ...
        '<section class="if-admin-directory-card if-admin-detail-section">' +
          ...
          '<div class="if-admin-search-row"><div class="form-group if-search-field"><label for="if-admin-creator-search">' + escapeHtml(L('searchCreators')) + '</label><input id="if-admin-creator-search" type="search" placeholder="' + escapeHtml(L('searchPlaceholder')) + '" autocomplete="off"/></div></div>' +
  ...
  function renderCreatorPagination(totalItems){
    ...
    el.innerHTML = '' +
      ...
      '<span class="if-pagination-status muted small">' + escapeHtml(String(state.creatorPage)) + ' / ' + escapeHtml(String(totalPages)) + '</span>' +
