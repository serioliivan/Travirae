...
(function(){
  ...
  var TEXT = {
    it: {
      title: 'Pannello influencer', chip: 'Creator Travirae',
      creatorList: 'Creator',
      ...
      creatorChip: 'Travirae Creator'
    },
    en: {
      title: 'Influencer panel', chip: 'Travirae Creator',
  ...
  var ADMIN_TEXT_OVERRIDES = {
  "de": {
    "title": "Influencer-Panel",
    "chip": "Travirae Creator",
    "creatorList": "Creator",
    "creatorHint": "Klicke auf einen Creator, um Profil, Prüfungen und Beiträge zu öffnen oder zu schließen.",
    "liveProfile": "Live-Profil",
    "pendingProfile": "Ausstehende Profilprüfung",
    "livePost": "Live-Beitrag",
    "pendingPost": "Ausstehende Beitragsprüfung",
    "profileMeta": "Profilmetadaten",
    "postMeta": "Beitragsmetadaten",
    "saveMeta": "Metadaten speichern",
    "noCreator": "Keine Creator verfügbar.",
    "noPending": "Keine ausstehende Prüfung.",
    "reviewNotes": "Prüfnotizen",
    "logout": "Abmelden",
    "loginSuccess": "Influencer-Admin erfolgreich angemeldet.",
    "queueProfiles": "Ausstehende Profile",
    "queuePosts": "Ausstehende Beiträge",
    "queueChanges": "Ausstehende Änderungen",
    "noPosts": "Keine Beiträge für diesen Creator.",
    "contentPreview": "Inhaltsvorschau",
    "excerpt": "Auszug",
    "bio": "Bio",
    "displayName": "Profilname",
    "publicSlug": "Öffentlicher Slug",
    "titleLabel": "Titel",
    "postSlug": "Beitrag-Slug",
    "saveOk": "Admin-Aktualisierung gespeichert.",
    "deleteProfile": "Profil löschen",
    "deletePost": "Beitrag löschen",
    "requestChangesLive": "Änderungen anfordern",
    "cancelRequestedChanges": "Änderungsanfrage abbrechen",
    "confirmDeleteProfile": "Möchtest du dieses Profil wirklich löschen? Der Creator wird gesperrt und öffentliche Inhalte sind nicht mehr sichtbar.",
    "confirmDeletePost": "Möchtest du diesen Beitrag wirklich löschen?",
    "confirmArchivePost": "Möchtest du diesen Beitrag wirklich archivieren?",
    "yesDelete": "Ja, löschen",
    "yesArchive": "Ja, archivieren",
    "no": "Abbrechen",
    "actions": "Admin-Aktionen",
    "closeCreator": "Schließen",
    "openCreator": "Öffnen",
    "deletedOk": "Element erfolgreich aktualisiert.",
    "profileDeletedOk": "Profil erfolgreich gesperrt.",
    "postDeletedOk": "Beitrag erfolgreich gelöscht.",
    "archivePost": "Beitrag archivieren",
    "liveActions": "Aktionen für Live-Inhalte",
    "viewInfo": "Informationen anzeigen",
    "hideInfo": "Informationen ausblenden",
    "postsSection": "Beiträge des Creators",
    "reviewRequested": "Prüfung angefordert",
    "viewPreview": "Vorschau öffnen",
  ...
  "es": {
    "title": "Panel de influencers",
    "chip": "Creador de Travirae",
    "creatorList": "Creadores",
    "creatorHint": "Haz clic en un creador para abrir o cerrar el perfil, las revisiones y los posts.",
    "liveProfile": "Perfil en vivo",
    "pendingProfile": "Revisión de perfil pendiente",
    "livePost": "Post en vivo",
    "pendingPost": "Revisión de post pendiente",
    "profileMeta": "Metadatos del perfil",
    "postMeta": "Metadatos del post",
    "saveMeta": "Guardar metadatos",
    "noCreator": "No hay creadores disponibles.",
    "noPending": "No hay revisiones pendientes.",
    "reviewNotes": "Notas de revisión",
    "logout": "Salir",
    "loginSuccess": "Acceso admin influencer realizado.",
    "queueProfiles": "Perfiles pendientes",
    "queuePosts": "Posts pendientes",
    "queueChanges": "Cambios pendientes",
    "noPosts": "No hay posts para este creador.",
    ...
    "titleLabel": "Título",
    "postSlug": "Slug del post",
    "saveOk": "Actualización del admin guardada.",
    "deleteProfile": "Eliminar perfil",
    "deletePost": "Eliminar post",
    "requestChangesLive": "Solicitar cambios",
    "cancelRequestedChanges": "Cancelar solicitud de cambios",
    "confirmDeleteProfile": "¿Seguro que quieres eliminar este perfil? El creador será suspendido y el contenido público dejará de ser visible.",
    "confirmDeletePost": "¿Seguro que quieres eliminar este post?",
    "confirmArchivePost": "¿Seguro que quieres archivar este post?",
    "yesDelete": "Sí, eliminar",
    "yesArchive": "Sí, archivar",
    "no": "Cancelar",
    "actions": "Acciones admin",
    "closeCreator": "Cerrar",
    "openCreator": "Abrir",
    "deletedOk": "Elemento actualizado correctamente.",
    "profileDeletedOk": "Perfil suspendido correctamente.",
    "postDeletedOk": "Post eliminado correctamente.",
    "archivePost": "Archivar post",
    "liveActions": "Acciones sobre el contenido en vivo",
    "viewInfo": "Ver información",
    "hideInfo": "Ocultar información",
    "postsSection": "Posts del creador",
    "reviewRequested": "Revisión solicitada",
    "viewPreview": "Abrir vista previa",
    "hidePreview": "Cerrar vista previa",
    "searchCreators": "Buscar creadores",
    "searchPlaceholder": "Buscar aquí…",
    "creatorChip": "Creator de Travirae"
  },
  "fr": {
    "title": "Panneau influenceur",
    "creatorList": "Créateurs",
    "creatorHint": "Cliquez sur un créateur pour ouvrir ou fermer le profil, les révisions et les posts.",
    "liveProfile": "Profil en ligne",
    "pendingProfile": "Révision du profil en attente",
    "livePost": "Post en ligne",
    "pendingPost": "Révision du post en attente",
    "profileMeta": "Métadonnées du profil",
    "postMeta": "Métadonnées du post",
    "saveMeta": "Enregistrer les métadonnées",
    "noCreator": "Aucun créateur disponible.",
    "noPending": "Aucune révision en attente.",
    "reviewNotes": "Notes de révision",
    "logout": "Se déconnecter",
    "loginSuccess": "Connexion admin influenceur réussie.",
    "queueProfiles": "Profils en attente",
    "queuePosts": "Posts en attente",
    "queueChanges": "Modifications en attente",
    "noPosts": "Aucun post pour ce créateur.",
    ...
    "titleLabel": "Titre",
    "postSlug": "Slug du post",
    "saveOk": "Mise à jour admin enregistrée.",
    "deleteProfile": "Supprimer le profil",
    "deletePost": "Supprimer le post",
    "requestChangesLive": "Demander des modifications",
    "cancelRequestedChanges": "Annuler la demande de modifications",
    "confirmDeleteProfile": "Voulez-vous vraiment supprimer ce profil ? Le créateur sera suspendu et le contenu public ne sera plus visible.",
    "confirmDeletePost": "Voulez-vous vraiment supprimer ce post ?",
    "confirmArchivePost": "Voulez-vous vraiment archiver ce post ?",
    ...
    "closeCreator": "Fermer",
    "openCreator": "Ouvrir",
    "deletedOk": "Élément mis à jour avec succès.",
    "profileDeletedOk": "Profil suspendu avec succès.",
    "postDeletedOk": "Post supprimé avec succès.",
    "archivePost": "Archiver le post",
    "liveActions": "Actions sur le contenu en ligne",
    "viewInfo": "Voir les informations",
    "hideInfo": "Masquer les informations",
    "postsSection": "Posts du créateur",
    "reviewRequested": "Révision demandée",
    "viewPreview": "Ouvrir l’aperçu",
  ...
  "nl": {
    "title": "Influencerpaneel",
    "chip": "Travirae Creator",
    "creatorList": "Creators",
    "creatorHint": "Klik op een creator om profiel, beoordelingen en berichten te openen of te sluiten.",
    "liveProfile": "Live-profiel",
    "pendingProfile": "Profielbeoordeling in afwachting",
    "livePost": "Live-bericht",
    "pendingPost": "Berichtbeoordeling in afwachting",
    "profileMeta": "Profielmetadata",
    "postMeta": "Berichtmetadata",
    "saveMeta": "Metadata opslaan",
    "noCreator": "Geen creators beschikbaar.",
    "noPending": "Geen beoordeling in afwachting.",
    "reviewNotes": "Beoordelingsnotities",
    "logout": "Uitloggen",
    "loginSuccess": "Influencer-admin succesvol aangemeld.",
    "queueProfiles": "Profielen in afwachting",
    "queuePosts": "Berichten in afwachting",
    "queueChanges": "Wijzigingen in afwachting",
    "noPosts": "Geen berichten voor deze creator.",
    "contentPreview": "Inhoudsvoorbeeld",
    "excerpt": "Fragment",
    "bio": "Bio",
    "displayName": "Profielnaam",
    "publicSlug": "Openbare slug",
    "titleLabel": "Titel",
    "postSlug": "Berichtslug",
    "saveOk": "Admin-update opgeslagen.",
    "deleteProfile": "Profiel verwijderen",
    "deletePost": "Bericht verwijderen",
    "requestChangesLive": "Wijzigingen aanvragen",
    "cancelRequestedChanges": "Wijzigingsverzoek annuleren",
    "confirmDeleteProfile": "Weet je zeker dat je dit profiel wilt verwijderen? De creator wordt geschorst en publieke inhoud is niet langer zichtbaar.",
    "confirmDeletePost": "Weet je zeker dat je dit bericht wilt verwijderen?",
    "confirmArchivePost": "Weet je zeker dat je dit bericht wilt archiveren?",
    "yesDelete": "Ja, verwijderen",
    "yesArchive": "Ja, archiveren",
    "no": "Annuleren",
    "actions": "Admin-acties",
    "closeCreator": "Sluiten",
    "openCreator": "Openen",
    "deletedOk": "Item succesvol bijgewerkt.",
    "profileDeletedOk": "Profiel succesvol geschorst.",
    "postDeletedOk": "Bericht succesvol verwijderd.",
    "archivePost": "Bericht archiveren",
    "liveActions": "Acties op live-inhoud",
    "viewInfo": "Informatie bekijken",
    "hideInfo": "Informatie verbergen",
    "postsSection": "Berichten van creator",
    "reviewRequested": "Beoordeling aangevraagd",
    "viewPreview": "Voorbeeld openen",
    "hidePreview": "Voorbeeld sluiten",
    "searchCreators": "Zoek creators",
    "searchPlaceholder": "Zoek hier…",
    "creatorChip": "Creator de Travirae"
  },
  "ru": {
    "title": "Панель авторов",
    "creatorList": "Авторы",
    "creatorHint": "Нажмите на автора, чтобы открыть или закрыть профиль, ревизии и посты.",
    "liveProfile": "Публичный профиль",
    "pendingProfile": "Проверка профиля в ожидании",
    "livePost": "Опубликованный пост",
    "pendingPost": "Проверка поста в ожидании",
    "profileMeta": "Метаданные профиля",
    "postMeta": "Метаданные поста",
    "saveMeta": "Сохранить метаданные",
    "noCreator": "Нет доступных авторов.",
    "noPending": "Нет ревизий в ожидании.",
    "reviewNotes": "Заметки проверки",
    "logout": "Выйти",
    "loginSuccess": "Вход в панель авторов выполнен.",
    "queueProfiles": "Профили в ожидании",
    "queuePosts": "Посты в ожидании",
    "queueChanges": "Изменения в ожидании",
    "noPosts": "У этого автора нет постов.",
    "contentPreview": "Предпросмотр содержимого",
    "excerpt": "Краткое описание",
    "bio": "Био",
    "displayName": "Имя профиля",
    "publicSlug": "Публичный слаг",
    "titleLabel": "Заголовок",
    "postSlug": "Слаг поста",
    "saveOk": "Изменения администратора сохранены.",
    "deleteProfile": "Удалить профиль",
    "deletePost": "Удалить пост",
    "requestChangesLive": "Запросить изменения",
    "cancelRequestedChanges": "Отменить запрос изменений",
    "confirmDeleteProfile": "Вы уверены, что хотите удалить этот профиль? Автор будет заблокирован, а публичный контент перестанет отображаться.",
    "confirmDeletePost": "Вы уверены, что хотите удалить этот пост?",
    "confirmArchivePost": "Вы уверены, что хотите архивировать этот пост?",
    "yesDelete": "Да, удалить",
    "yesArchive": "Да, архивировать",
    "no": "Отмена",
    "actions": "Действия администратора",
    "closeCreator": "Закрыть",
    "openCreator": "Открыть",
    "deletedOk": "Элемент успешно обновлён.",
    "profileDeletedOk": "Профиль успешно заблокирован.",
    "postDeletedOk": "Пост успешно удалён.",
    "archivePost": "Архивировать пост",
    "liveActions": "Действия с опубликованным контентом",
    "viewInfo": "Показать информацию",
    "hideInfo": "Скрыть информацию",
    "postsSection": "Посты автора",
    "reviewRequested": "Запрошена проверка",
    "viewPreview": "Открыть предпросмотр",
    "hidePreview": "Закрыть предпросмотр",
  ...
  "ar": {
    "title": "لوحة المؤثرين",
    "chip": "منشئ Travirae",
    "creatorList": "المنشئون",
    "creatorHint": "انقر على منشئ لفتح أو إغلاق الملف والمراجعات والمقالات.",
    "liveProfile": "الملف المنشور",
    "pendingProfile": "مراجعة الملف المعلقة",
    "livePost": "المنشور المنشور",
    "pendingPost": "مراجعة المنشور المعلقة",
    "profileMeta": "بيانات الملف",
    "postMeta": "بيانات المنشور",
    "saveMeta": "حفظ البيانات",
    "noCreator": "لا يوجد منشئون متاحون.",
    "noPending": "لا توجد مراجعات معلقة.",
    "reviewNotes": "ملاحظات المراجعة",
    "logout": "تسجيل الخروج",
    "loginSuccess": "تم تسجيل دخول لوحة المؤثرين بنجاح.",
    "queueProfiles": "الملفات المعلقة",
    "queuePosts": "المنشورات المعلقة",
    "queueChanges": "التعديلات المعلقة",
    "noPosts": "لا توجد منشورات لهذا المنشئ.",
    "contentPreview": "معاينة المحتوى",
    "excerpt": "مقتطف",
    "bio": "نبذة",
    "displayName": "اسم الملف",
    "publicSlug": "المعرف العام",
    "titleLabel": "العنوان",
    "postSlug": "معرف المنشور",
    "saveOk": "تم حفظ تحديث الإدارة.",
    "deleteProfile": "حذف الملف",
    "deletePost": "حذف المنشور",
    "requestChangesLive": "طلب تعديلات",
    "cancelRequestedChanges": "إلغاء طلب التعديلات",
    "confirmDeleteProfile": "هل أنت متأكد من حذف هذا الملف؟ سيتم تعليق المنشئ ولن يعود المحتوى العام مرئياً.",
    "confirmDeletePost": "هل أنت متأكد من حذف هذا المنشور؟",
    "confirmArchivePost": "هل أنت متأكد من أرشفة هذا المنشور؟",
    "yesDelete": "نعم، احذف",
    "yesArchive": "نعم، أرشف",
    "no": "إلغاء",
    ...
    "closeCreator": "إغلاق",
    "openCreator": "فتح",
    "deletedOk": "تم تحديث العنصر بنجاح.",
    "profileDeletedOk": "تم تعليق الملف بنجاح.",
    "postDeletedOk": "تم حذف المنشور بنجاح.",
    "archivePost": "أرشفة المنشور",
    "liveActions": "إجراءات المحتوى المنشور",
    "viewInfo": "عرض المعلومات",
    "hideInfo": "إخفاء المعلومات",
    "postsSection": "منشورات المنشئ",
    "reviewRequested": "تم طلب مراجعة",
    "viewPreview": "فتح المعاينة",
    "hidePreview": "إغلاق المعاينة",
    "searchCreators": "ابحث عن منشئ",
  ...
  "zh": {
    "title": "创作者面板",
    "creatorList": "创作者",
    "creatorHint": "点击创作者以展开或收起资料、审核和文章。",
    "liveProfile": "上线资料",
    "pendingProfile": "待审核资料",
    "livePost": "已上线文章",
    "pendingPost": "待审核文章",
    "profileMeta": "资料元数据",
    "postMeta": "文章元数据",
    ...
    "deleteProfile": "删除资料",
    "deletePost": "删除文章",
    "requestChangesLive": "要求修改",
    "cancelRequestedChanges": "取消修改请求",
    "confirmDeleteProfile": "确定要删除此资料吗？创作者将被停用，公开内容将不再可见。",
    "confirmDeletePost": "确定要删除这篇文章吗？",
    "confirmArchivePost": "确定要归档这篇文章吗？",
    "yesDelete": "是，删除",
    "yesArchive": "是，归档",
    "no": "取消",
    "actions": "管理员操作",
    ...
    "openCreator": "打开",
    "deletedOk": "项目已成功更新。",
    "profileDeletedOk": "资料已成功停用。",
    "postDeletedOk": "文章已成功删除。",
    "archivePost": "归档文章",
    "liveActions": "对上线内容的操作",
    "viewInfo": "查看信息",
    "hideInfo": "隐藏信息",
    "postsSection": "创作者文章",
  ...
  Object.keys(ADMIN_TEXT_OVERRIDES).forEach(function(lang){
    TEXT[lang] = Object.assign({}, TEXT[lang] || {}, ADMIN_TEXT_OVERRIDES[lang]);
  });

  var ADMIN_TEXT_FIXES_V51 = {
    fr: { title: 'Panneau influenceurs', searchCreators: 'Rechercher des créateurs', searchPlaceholder: 'Rechercher ici…' },
    nl: { title: 'Influencerpaneel', searchCreators: 'Creators zoeken', searchPlaceholder: 'Hier zoeken…' },
    ru: { title: 'Панель инфлюенсеров', searchCreators: 'Искать авторов', searchPlaceholder: 'Искать здесь…' },
    ar: { title: 'لوحة المؤثرين', searchCreators: 'ابحث عن صناع المحتوى', searchPlaceholder: 'ابحث هنا…' },
    zh: { title: '达人面板', searchCreators: '搜索创作者', searchPlaceholder: '在此搜索…' }
  };
  Object.keys(ADMIN_TEXT_FIXES_V51).forEach(function(lang){
    TEXT[lang] = Object.assign({}, TEXT[lang] || {}, ADMIN_TEXT_FIXES_V51[lang]);
  });
  function L(key){
    var shared = t(key);
    ...
    view.innerHTML = '' +
      '<div class="if-admin-shell if-admin-shell--accordion">' +
        '<div class="if-admin-topbar">' +
          '<div class="if-admin-topbar__copy"><span class="chip">' + escapeHtml(L('creatorChip') || 'Travirae Creator') + '</span><h2>' + escapeHtml(L('title')) + '</h2><p class="muted small">' + escapeHtml(L('creatorHint')) + '</p></div>' +
