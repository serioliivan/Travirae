...
(function(){
  var cache = null; // memoized { key: src }
  var lastBtn = null;
  ...
  function setMapFor(btn){
    ...
    loadMapping().then(function(map){
      ...
      if(src){
        ...
        frame.src = src; // src contains your affiliate markers from Excel
  ...
  // Safety: when modal opens via class toggle, ensure correct map is applied
  var modal = document.getElementById('destination-modal');
