...
(function(){
  ...
  function setMapFor(btn){
    ...
    loadMapping().then(function(map){
      ...
      mount.innerHTML = '';
      if(src){
        // Aggiungi campaign affiliato se presente
        try{
          var aff = window.traviraeAffiliate && typeof window.traviraeAffiliate.getId === 'function'
          ...
          console.error('Errore impostazione campaign Stay22 per mappa', e);
        }
