...
(function(){
  ...
  document.addEventListener('click', function(e){
    ...
    if(btn){
      ...
      // Lo consideriamo un "booking click" verso Stay22 (una volta per click sul bottone).
      try {
        if (window.traviraeAffiliate && typeof window.traviraeAffiliate.trackBookingClick === 'function') {
          if (window.console && console.log) console.log('Travirae: apertura mappa Stay22 (destinazione)');
          window.traviraeAffiliate.trackBookingClick('stay22');
        }
      } catch(eTrack) {
