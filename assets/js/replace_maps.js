        ...
        try {
          ...
          if (affId && src) {
            ...
            try {
              ...
              if (window.console && console.warn) console.warn('Errore tracking booking Stay22 (mappe dinamiche)', eTrack);
            }
          }
        } catch(eAff) {
          if (window.console && console.warn) {
            console.warn('Errore impostazione campaign Stay22', eAff);
          }
        }
