...
(function(){
    ...
    return '' +
      '<div class="if-block-insert ' + I.escapeAttr(extraClass || '') + '">' +
        '<div class="if-add-menu" data-add-menu="1" data-insert-index="' + I.escapeAttr(rawIndex) + '">' +
          '<button class="btn secondary if-add-menu__toggle" type="button" data-add-menu-toggle="1" aria-label="' + I.escapeAttr(label) + '" title="' + I.escapeAttr(label) + '">' + I.escapeHtml(label) + '</button>' +
  ...
  function renderEditor(){
    ...
    (editor.blocks || []).forEach(function(block, index){
