    ...
    blocksWrap.innerHTML = (editor.blocks || []).map(function(block, index){
      ...
      if (block.type === 'heading'){
        ...
        body = '' +
          ...
          '<div class="form-row-2"><div class="form-group"><label>' + I.escapeHtml(L('fieldDepartDate')) + '</label><input type="date" value="' + I.escapeAttr(block.checkin || '') + '" data-block-field="checkin" data-index="' + index + '"/></div><div class="form-group"><label>' + I.escapeHtml(L('fieldReturnDate')) + '</label><input type="date" value="' + I.escapeAttr(block.returnDate || '') + '" data-block-field="returnDate" data-index="' + index + '"/></div></div>' +
          '<div class="form-group"><label>' + I.escapeHtml(L('fieldDescription')) + '</label><textarea rows="3" data-block-field="description" data-index="' + index + '">' + I.escapeHtml(block.description || '') + '</textarea></div>';
      }
