...
(function(){
  ...
  function hasApprovedProfile(){
    ...
    return status === 'published' || status === 'changes_requested' || status === 'archived';
  }
  ...
  function renderProfileUi(){
    ...
    var introVisible = !hasApproved && !state.profileFormOpen;
    var summaryVisible = hasApproved && !!state.profilePublishedRevision;
