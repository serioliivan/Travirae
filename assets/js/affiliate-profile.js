...
(function(){
  ...
  var CREATOR_METRIC_LABEL_FIXES_V2 = {
    it: { widgetClicks: 'Click widget outbound', bookingConfirmed: 'Vendite confermate dai tuoi post', creatorStatsHint: 'Queste statistiche sono private, visibili solo a te e rappresentano totali storici.' },
    en: { widgetClicks: 'Outbound widget clicks', bookingConfirmed: 'Confirmed sales from your posts', creatorStatsHint: 'These statistics are private, visible only to you, and shown as lifetime totals.' },
    de: { widgetClicks: 'Outbound-Widget-Klicks', bookingConfirmed: 'Bestätigte Verkäufe aus deinen Posts', creatorStatsHint: 'Diese Statistiken sind privat, nur für dich sichtbar und werden als historische Gesamtwerte angezeigt.' },
    es: { widgetClicks: 'Clics outbound en widgets', bookingConfirmed: 'Ventas confirmadas de tus posts', creatorStatsHint: 'Estas estadísticas son privadas, solo visibles para ti y se muestran como totales históricos.' },
    fr: { widgetClicks: 'Clics widget sortants', bookingConfirmed: 'Ventes confirmées de vos posts', creatorStatsHint: 'Ces statistiques sont privées, visibles uniquement par vous et affichées comme des totaux historiques.' },
    nl: { widgetClicks: 'Uitgaande widgetklikken', bookingConfirmed: 'Bevestigde verkopen uit je posts', creatorStatsHint: 'Deze statistieken zijn privé, alleen voor jou zichtbaar en worden als historische totalen weergegeven.' },
    ru: { widgetClicks: 'Исходящие клики по виджету', bookingConfirmed: 'Подтверждённые продажи из ваших постов', creatorStatsHint: 'Эта статистика приватная, видна только вам и отображается как исторические итоги.' },
    ar: { widgetClicks: 'نقرات الودجت الخارجية', bookingConfirmed: 'المبيعات المؤكدة من منشوراتك', creatorStatsHint: 'هذه الإحصاءات خاصة وتظهر لك فقط ويتم عرضها كإجماليات تاريخية.' },
    zh: { widgetClicks: '外跳组件点击', bookingConfirmed: '来自你帖子的已确认销售', creatorStatsHint: '这些统计数据为私人数据，仅你可见，并以历史累计总数显示。' }
  };
