      ...
      function updateMenu(){
        ...
        var resolver = kind === 'airport' && typeof I.searchAirportSuggestions === 'function'
          ...
          : (typeof I.ensureWidgetAutocompleteCatalog === 'function'
              ? I.ensureWidgetAutocompleteCatalog().then(function(){ return typeof I.searchStay22Destinations === 'function' ? I.searchStay22Destinations(term, 3) : []; })
              : Promise.resolve(typeof I.searchStay22Destinations === 'function' ? I.searchStay22Destinations(term, 3) : []));
