...
(function(){
  ...
  function renderProfileUi(){
    ...
    var profileVisible = hasPublished || state.profileFormOpen;
    var statsVisible = hasPublished;
    ...
    if (grid) grid.hidden = !profileVisible;
  ...
  async function saveProfile(){
    ...
    try{
      ...
      await loadDashboardData();
      state.profileFormOpen = hasPublishedProfile();
      renderProfileUi();
