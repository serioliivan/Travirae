...
- `supabase/sql/SCRIPT_20_supabase_explicit_grants_2026.sql`  ✅ (patch GRANT Data API Supabase 2026)

✅ Opzionale (solo se vuoi CRON con pg_cron)
- `supabase/sql/SCRIPT_06_cron_import_travelpayouts.sql`

> Se stai usando un progetto nuovo/pulito, esegui `SCRIPT_20_supabase_explicit_grants_2026.sql` alla fine: è idempotente e mantiene espliciti i permessi Data API richiesti da Supabase.

### 2.1) Fix Supabase 2026 — GRANTS espliciti

Supabase richiede permessi espliciti per rendere tabelle, viste e funzioni raggiungibili dalla Data API. Per questo progetto esegui sempre anche:

- `supabase/sql/SCRIPT_20_supabase_explicit_grants_2026.sql`

Lo script non disattiva RLS, non cancella dati e può essere rieseguito più volte. Serve a prevenire errori `42501` su `supabase-js`, PostgREST e GraphQL.
