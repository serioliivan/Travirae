> [!NOTE]
> Da questa versione il frontend non traccia più booking click e non usa overlay invisibili sui widget.
> Per le dashboard contano soprattutto landing affiliate, traffico e vendite confermate importate dai partner.
...
- Hai eseguito gli script SQL in `supabase/sql/`, incluso `SCRIPT_20_supabase_explicit_grants_2026.sql` per i permessi Data API espliciti.
...
4. Se importi manualmente anche Stay22, usa **Importa Stay22 CSV** quando serve
