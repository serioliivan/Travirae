...
-- GRANT espliciti per Supabase Data API/PostgREST (rollout 2026).
-- RLS e policy restano nello SCRIPT_04: questi permessi rendono solo gli oggetti raggiungibili dalla Data API.
