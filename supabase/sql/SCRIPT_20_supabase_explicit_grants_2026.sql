-- SCRIPT 20 — Supabase Data API explicit GRANTS 2026
-- ============================================================================
-- Scopo:
...
-- Dopo questo script, esegui anche SCRIPT_21_supabase_advisor_hardening.sql
-- per correggere Security Advisor / Performance Advisor senza rompere RLS.
