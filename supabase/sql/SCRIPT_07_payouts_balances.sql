...
-- GRANT esplicito per service role/trigger utility.
...
-- GRANT esplicito per la funzione di validazione usata dai trigger.
...
create or replace view public.admin_affiliate_overview with (security_invoker = true) as
with clicks as (
...
-- Grants espliciti per Supabase Data API/PostgREST
