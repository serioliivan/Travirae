-- SCRIPT 16 — Hotfix for admin_affiliate_overview / widget outbound totals
--
-- Use this if SCRIPT_14 or SCRIPT_15 failed with an error like:
--   cannot change name of view column "booking_clicks_total" to "widget_clicks_total"
--
-- This hotfix simply applies the safe DROP + CREATE version.
